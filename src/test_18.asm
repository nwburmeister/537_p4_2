...
main(int argc, char *argv[])
{
  ...
  a2:	50                   	push   %eax
  a3:	e8 c2 03 00 00       	call   46a <getpinfo>
  ...
  f9:	6a 02                	push   $0x2
  fb:	e8 62 03 00 00       	call   462 <fork2>
 ...
 1f2:	e8 73 02 00 00       	call   46a <getpinfo>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d0:	0f b6 92 78 08 00 00 	movzbl 0x878(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 60c:	75 28                	jne    636 <printf+0x12a>
          s = "(null)";
 60e:	be 70 08 00 00       	mov    $0x870,%esi
...
free(void *ap)
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 6c 0b 00 00       	mov    %eax,0xb6c
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 745:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 748:	8b 0d 6c 0b 00 00    	mov    0xb6c,%ecx
 ...
 754:	eb 4d                	jmp    7a3 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 75d:	0b 00 00 
 760:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 767:	0b 00 00 
    base.s.size = 0;
 76a:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 771:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 774:	b9 70 0b 00 00       	mov    $0xb70,%ecx
 ...
 787:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 78a:	89 0d 6c 0b 00 00    	mov    %ecx,0xb6c
      return (void*)(p + 1);
 ...
 7a8:	73 d1                	jae    77b <malloc+0x46>
    if(p == freep)
 7aa:	39 05 6c 0b 00 00    	cmp    %eax,0xb6c
