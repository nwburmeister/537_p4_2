...
printint(int fd, int xx, int base, int sgn)
{
 ...
 31c:	0f b6 92 44 06 00 00 	movzbl 0x644(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 458:	75 28                	jne    482 <printf+0x12a>
          s = "(null)";
 45a:	be 3d 06 00 00       	mov    $0x63d,%esi
...
free(void *ap)
{
 ...
 4cd:	a1 e8 08 00 00       	mov    0x8e8,%eax
 ...
 509:	89 08                	mov    %ecx,(%eax)
  freep = p;
 50b:	a3 e8 08 00 00       	mov    %eax,0x8e8
}
 510:	5b                   	pop    %ebx
 511:	5e                   	pop    %esi
 512:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 568:	e8 54 ff ff ff       	call   4c1 <free>
  return freep;
 56d:	a1 e8 08 00 00       	mov    0x8e8,%eax
...
malloc(uint nbytes)
{
 ...
 591:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 594:	8b 0d e8 08 00 00    	mov    0x8e8,%ecx
 ...
 5a0:	eb 4d                	jmp    5ef <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 5a2:	c7 05 e8 08 00 00 ec 	movl   $0x8ec,0x8e8
 5a9:	08 00 00 
 5ac:	c7 05 ec 08 00 00 ec 	movl   $0x8ec,0x8ec
 5b3:	08 00 00 
    base.s.size = 0;
 5b6:	c7 05 f0 08 00 00 00 	movl   $0x0,0x8f0
 5bd:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5c0:	b9 ec 08 00 00       	mov    $0x8ec,%ecx
 ...
 5d3:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5d6:	89 0d e8 08 00 00    	mov    %ecx,0x8e8
      return (void*)(p + 1);
 ...
 5f4:	73 d1                	jae    5c7 <malloc+0x46>
    if(p == freep)
 5f6:	39 05 e8 08 00 00    	cmp    %eax,0x8e8
