...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	ff 35 74 5b 00 00    	pushl  0x5b74
      11:	e8 64 38 00 00       	call   387a <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      6d:	ff 35 74 5b 00 00    	pushl  0x5b74
      73:	e8 02 38 00 00       	call   387a <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      85:	ff 35 74 5b 00 00    	pushl  0x5b74
      8b:	e8 ea 37 00 00       	call   387a <printf>
    exit();
      90:	e8 8b 36 00 00       	call   3720 <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 42 3b 00 00       	push   $0x3b42
      9d:	ff 35 74 5b 00 00    	pushl  0x5b74
      a3:	e8 d2 37 00 00       	call   387a <printf>
    exit();
      a8:	e8 73 36 00 00       	call   3720 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 63 3b 00 00       	push   $0x3b63
      b5:	ff 35 74 5b 00 00    	pushl  0x5b74
      bb:	e8 ba 37 00 00       	call   387a <printf>
    exit();
      c0:	e8 5b 36 00 00       	call   3720 <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 7f 3b 00 00       	push   $0x3b7f
      cd:	ff 35 74 5b 00 00    	pushl  0x5b74
      d3:	e8 a2 37 00 00       	call   387a <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e8:	ff 35 74 5b 00 00    	pushl  0x5b74
      ee:	e8 87 37 00 00       	call   387a <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     10a:	68 5b 3b 00 00       	push   $0x3b5b
    ...
    if(chdir("iputdir") < 0){
     ...
     11e:	68 5b 3b 00 00       	push   $0x3b5b
    ...
    if(unlink("../iputdir") < 0){
     ...
     132:	68 58 3b 00 00       	push   $0x3b58
    ...
    printf(stdout, "fork failed\n");
     ...
     14b:	68 75 4a 00 00       	push   $0x4a75
     150:	ff 35 74 5b 00 00    	pushl  0x5b74
     156:	e8 1f 37 00 00       	call   387a <printf>
    exit();
     15b:	e8 c0 35 00 00       	call   3720 <exit>
      printf(stdout, "mkdir failed\n");
     160:	83 ec 08             	sub    $0x8,%esp
     163:	68 34 3b 00 00       	push   $0x3b34
     168:	ff 35 74 5b 00 00    	pushl  0x5b74
     16e:	e8 07 37 00 00       	call   387a <printf>
      exit();
     173:	e8 a8 35 00 00       	call   3720 <exit>
      printf(stdout, "child chdir failed\n");
     178:	83 ec 08             	sub    $0x8,%esp
     17b:	68 9e 3b 00 00       	push   $0x3b9e
     180:	ff 35 74 5b 00 00    	pushl  0x5b74
     186:	e8 ef 36 00 00       	call   387a <printf>
      exit();
     18b:	e8 90 35 00 00       	call   3720 <exit>
      printf(stdout, "unlink ../iputdir failed\n");
     190:	83 ec 08             	sub    $0x8,%esp
     193:	68 63 3b 00 00       	push   $0x3b63
     198:	ff 35 74 5b 00 00    	pushl  0x5b74
     19e:	e8 d7 36 00 00       	call   387a <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b0:	68 b2 3b 00 00       	push   $0x3bb2
     1b5:	ff 35 74 5b 00 00    	pushl  0x5b74
     1bb:	e8 ba 36 00 00       	call   387a <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cb:	68 c4 3b 00 00       	push   $0x3bc4
     1d0:	ff 35 74 5b 00 00    	pushl  0x5b74
     1d6:	e8 9f 36 00 00       	call   387a <printf>
  if(mkdir("oidir") < 0){
     1db:	c7 04 24 d3 3b 00 00 	movl   $0x3bd3,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     1fe:	6a 02                	push   $0x2
     200:	68 d3 3b 00 00       	push   $0x3bd3
    ...
    if(fd >= 0){
     ...
     214:	68 58 4b 00 00       	push   $0x4b58
     219:	ff 35 74 5b 00 00    	pushl  0x5b74
     21f:	e8 56 36 00 00       	call   387a <printf>
      exit();
     224:	e8 f7 34 00 00       	call   3720 <exit>
    printf(stdout, "mkdir oidir failed\n");
     229:	83 ec 08             	sub    $0x8,%esp
     22c:	68 d9 3b 00 00       	push   $0x3bd9
     231:	ff 35 74 5b 00 00    	pushl  0x5b74
     237:	e8 3e 36 00 00       	call   387a <printf>
    exit();
     23c:	e8 df 34 00 00       	call   3720 <exit>
    printf(stdout, "fork failed\n");
     241:	83 ec 08             	sub    $0x8,%esp
     244:	68 75 4a 00 00       	push   $0x4a75
     249:	ff 35 74 5b 00 00    	pushl  0x5b74
     24f:	e8 26 36 00 00       	call   387a <printf>
    exit();
  ...
  if(unlink("oidir") != 0){
     268:	c7 04 24 d3 3b 00 00 	movl   $0x3bd3,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     283:	68 fc 3b 00 00       	push   $0x3bfc
     288:	ff 35 74 5b 00 00    	pushl  0x5b74
     28e:	e8 e7 35 00 00       	call   387a <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     29b:	68 ed 3b 00 00       	push   $0x3bed
     2a0:	ff 35 74 5b 00 00    	pushl  0x5b74
     2a6:	e8 cf 35 00 00       	call   387a <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2b6:	68 0e 3c 00 00       	push   $0x3c0e
     2bb:	ff 35 74 5b 00 00    	pushl  0x5b74
     2c1:	e8 b4 35 00 00       	call   387a <printf>
  fd = open("echo", 0);
     2c6:	83 c4 08             	add    $0x8,%esp
     2c9:	6a 00                	push   $0x0
     2cb:	68 19 3c 00 00       	push   $0x3c19
  ...
  fd = open("doesnotexist", 0);
     ...
     2e8:	6a 00                	push   $0x0
     2ea:	68 31 3c 00 00       	push   $0x3c31
  ...
  printf(stdout, "open test ok\n");
     ...
     2fe:	68 5c 3c 00 00       	push   $0x3c5c
     303:	ff 35 74 5b 00 00    	pushl  0x5b74
     309:	e8 6c 35 00 00       	call   387a <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     316:	68 1e 3c 00 00       	push   $0x3c1e
     31b:	ff 35 74 5b 00 00    	pushl  0x5b74
     321:	e8 54 35 00 00       	call   387a <printf>
    exit();
     326:	e8 f5 33 00 00       	call   3720 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     32b:	83 ec 08             	sub    $0x8,%esp
     32e:	68 3e 3c 00 00       	push   $0x3c3e
     333:	ff 35 74 5b 00 00    	pushl  0x5b74
     339:	e8 3c 35 00 00       	call   387a <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     34b:	68 6a 3c 00 00       	push   $0x3c6a
     350:	ff 35 74 5b 00 00    	pushl  0x5b74
     356:	e8 1f 35 00 00       	call   387a <printf>
  fd = open("small", O_CREATE|O_RDWR);
     35b:	83 c4 08             	add    $0x8,%esp
     35e:	68 02 02 00 00       	push   $0x202
     363:	68 7b 3c 00 00       	push   $0x3c7b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     379:	68 81 3c 00 00       	push   $0x3c81
     37e:	ff 35 74 5b 00 00    	pushl  0x5b74
     384:	e8 f1 34 00 00       	call   387a <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     399:	6a 0a                	push   $0xa
     39b:	68 b8 3c 00 00       	push   $0x3cb8
     3a0:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     3b1:	6a 0a                	push   $0xa
     3b3:	68 c3 3c 00 00       	push   $0x3cc3
     3b8:	56                   	push   %esi
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3ce:	68 9c 3c 00 00       	push   $0x3c9c
     3d3:	ff 35 74 5b 00 00    	pushl  0x5b74
     3d9:	e8 9c 34 00 00       	call   387a <printf>
    exit();
     3de:	e8 3d 33 00 00       	call   3720 <exit>
      printf(stdout, "error: write aa %d new file failed\n", i);
     3e3:	83 ec 04             	sub    $0x4,%esp
     3e6:	53                   	push   %ebx
     3e7:	68 7c 4b 00 00       	push   $0x4b7c
     3ec:	ff 35 74 5b 00 00    	pushl  0x5b74
     3f2:	e8 83 34 00 00       	call   387a <printf>
      exit();
     3f7:	e8 24 33 00 00       	call   3720 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     3fc:	83 ec 04             	sub    $0x4,%esp
     3ff:	53                   	push   %ebx
     400:	68 a0 4b 00 00       	push   $0x4ba0
     405:	ff 35 74 5b 00 00    	pushl  0x5b74
     40b:	e8 6a 34 00 00       	call   387a <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     418:	68 ce 3c 00 00       	push   $0x3cce
     41d:	ff 35 74 5b 00 00    	pushl  0x5b74
     423:	e8 52 34 00 00       	call   387a <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     433:	6a 00                	push   $0x0
     435:	68 7b 3c 00 00       	push   $0x3c7b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     44b:	68 d9 3c 00 00       	push   $0x3cd9
     450:	ff 35 74 5b 00 00    	pushl  0x5b74
     456:	e8 1f 34 00 00       	call   387a <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     47b:	68 0d 3d 00 00       	push   $0x3d0d
     480:	ff 35 74 5b 00 00    	pushl  0x5b74
     486:	e8 ef 33 00 00       	call   387a <printf>
  } else {
  ...
  if(unlink("small") < 0){
     493:	c7 04 24 7b 3c 00 00 	movl   $0x3c7b,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     4a9:	68 35 3d 00 00       	push   $0x3d35
     4ae:	ff 35 74 5b 00 00    	pushl  0x5b74
     4b4:	e8 c1 33 00 00       	call   387a <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4c6:	68 f2 3c 00 00       	push   $0x3cf2
     4cb:	ff 35 74 5b 00 00    	pushl  0x5b74
     4d1:	e8 a4 33 00 00       	call   387a <printf>
    exit();
     4d6:	e8 45 32 00 00       	call   3720 <exit>
    printf(stdout, "read failed\n");
     4db:	83 ec 08             	sub    $0x8,%esp
     4de:	68 39 40 00 00       	push   $0x4039
     4e3:	ff 35 74 5b 00 00    	pushl  0x5b74
     4e9:	e8 8c 33 00 00       	call   387a <printf>
    exit();
     4ee:	e8 2d 32 00 00       	call   3720 <exit>
    printf(stdout, "unlink small failed\n");
     4f3:	83 ec 08             	sub    $0x8,%esp
     4f6:	68 20 3d 00 00       	push   $0x3d20
     4fb:	ff 35 74 5b 00 00    	pushl  0x5b74
     501:	e8 74 33 00 00       	call   387a <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     513:	68 49 3d 00 00       	push   $0x3d49
     518:	ff 35 74 5b 00 00    	pushl  0x5b74
     51e:	e8 57 33 00 00       	call   387a <printf>

  fd = open("big", O_CREATE|O_RDWR);
     523:	83 c4 08             	add    $0x8,%esp
     526:	68 02 02 00 00       	push   $0x202
     52b:	68 c3 3d 00 00       	push   $0x3dc3
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     576:	68 59 3d 00 00       	push   $0x3d59
     57b:	ff 35 74 5b 00 00    	pushl  0x5b74
     581:	e8 f4 32 00 00       	call   387a <printf>
    exit();
     586:	e8 95 31 00 00       	call   3720 <exit>
      printf(stdout, "error: write big file failed\n", i);
     58b:	83 ec 04             	sub    $0x4,%esp
     58e:	53                   	push   %ebx
     58f:	68 73 3d 00 00       	push   $0x3d73
     594:	ff 35 74 5b 00 00    	pushl  0x5b74
     59a:	e8 db 32 00 00       	call   387a <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     5b0:	6a 00                	push   $0x0
     5b2:	68 c3 3d 00 00       	push   $0x3dc3
  ...
  for(;;){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     604:	68 91 3d 00 00       	push   $0x3d91
     609:	ff 35 74 5b 00 00    	pushl  0x5b74
     60f:	e8 66 32 00 00       	call   387a <printf>
    exit();
  ...
  if(unlink("big") < 0){
     62a:	c7 04 24 c3 3d 00 00 	movl   $0x3dc3,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     640:	68 ea 3d 00 00       	push   $0x3dea
     645:	ff 35 74 5b 00 00    	pushl  0x5b74
     64b:	e8 2a 32 00 00       	call   387a <printf>
}
     ...
     65d:	53                   	push   %ebx
     65e:	68 aa 3d 00 00       	push   $0x3daa
     663:	ff 35 74 5b 00 00    	pushl  0x5b74
     669:	e8 0c 32 00 00       	call   387a <printf>
        exit();
     66e:	e8 ad 30 00 00       	call   3720 <exit>
      printf(stdout, "read failed %d\n", i);
     673:	83 ec 04             	sub    $0x4,%esp
     676:	50                   	push   %eax
     677:	68 c7 3d 00 00       	push   $0x3dc7
     67c:	ff 35 74 5b 00 00    	pushl  0x5b74
     682:	e8 f3 31 00 00       	call   387a <printf>
      exit();
     687:	e8 94 30 00 00       	call   3720 <exit>
      printf(stdout, "read content of block %d is %d\n",
     68c:	50                   	push   %eax
     68d:	53                   	push   %ebx
     68e:	68 c4 4b 00 00       	push   $0x4bc4
     693:	ff 35 74 5b 00 00    	pushl  0x5b74
     699:	e8 dc 31 00 00       	call   387a <printf>
      exit();
     69e:	e8 7d 30 00 00       	call   3720 <exit>
    printf(stdout, "unlink big failed\n");
     6a3:	83 ec 08             	sub    $0x8,%esp
     6a6:	68 d7 3d 00 00       	push   $0x3dd7
     6ab:	ff 35 74 5b 00 00    	pushl  0x5b74
     6b1:	e8 c4 31 00 00       	call   387a <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     6c2:	68 e4 4b 00 00       	push   $0x4be4
     6c7:	ff 35 74 5b 00 00    	pushl  0x5b74
     6cd:	e8 a8 31 00 00       	call   387a <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     74f:	68 0c 4c 00 00       	push   $0x4c0c
     754:	ff 35 74 5b 00 00    	pushl  0x5b74
     75a:	e8 1b 31 00 00       	call   387a <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     76d:	68 f8 3d 00 00       	push   $0x3df8
     772:	ff 35 74 5b 00 00    	pushl  0x5b74
     778:	e8 fd 30 00 00       	call   387a <printf>

  if(mkdir("dir0") < 0){
     77d:	c7 04 24 04 3e 00 00 	movl   $0x3e04,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     793:	68 04 3e 00 00       	push   $0x3e04
  ...
  if(chdir("..") < 0){
     ...
     7a7:	68 a9 43 00 00       	push   $0x43a9
  ...
  if(unlink("dir0") < 0){
     ...
     7bb:	68 04 3e 00 00       	push   $0x3e04
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7cf:	68 41 3e 00 00       	push   $0x3e41
     7d4:	ff 35 74 5b 00 00    	pushl  0x5b74
     7da:	e8 9b 30 00 00       	call   387a <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7e7:	68 34 3b 00 00       	push   $0x3b34
     7ec:	ff 35 74 5b 00 00    	pushl  0x5b74
     7f2:	e8 83 30 00 00       	call   387a <printf>
    exit();
     7f7:	e8 24 2f 00 00       	call   3720 <exit>
    printf(stdout, "chdir dir0 failed\n");
     7fc:	83 ec 08             	sub    $0x8,%esp
     7ff:	68 09 3e 00 00       	push   $0x3e09
     804:	ff 35 74 5b 00 00    	pushl  0x5b74
     80a:	e8 6b 30 00 00       	call   387a <printf>
    exit();
     80f:	e8 0c 2f 00 00       	call   3720 <exit>
    printf(stdout, "chdir .. failed\n");
     814:	83 ec 08             	sub    $0x8,%esp
     817:	68 1c 3e 00 00       	push   $0x3e1c
     81c:	ff 35 74 5b 00 00    	pushl  0x5b74
     822:	e8 53 30 00 00       	call   387a <printf>
    exit();
     827:	e8 f4 2e 00 00       	call   3720 <exit>
    printf(stdout, "unlink dir0 failed\n");
     82c:	83 ec 08             	sub    $0x8,%esp
     82f:	68 2d 3e 00 00       	push   $0x3e2d
     834:	ff 35 74 5b 00 00    	pushl  0x5b74
     83a:	e8 3b 30 00 00       	call   387a <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     84a:	68 50 3e 00 00       	push   $0x3e50
     84f:	ff 35 74 5b 00 00    	pushl  0x5b74
     855:	e8 20 30 00 00       	call   387a <printf>
  if(exec("echo", echoargv) < 0){
     85a:	83 c4 08             	add    $0x8,%esp
     85d:	68 78 5b 00 00       	push   $0x5b78
     862:	68 19 3c 00 00       	push   $0x3c19
    ...
    printf(stdout, "exec echo failed\n");
     ...
     878:	68 5b 3e 00 00       	push   $0x3e5b
     87d:	ff 35 74 5b 00 00    	pushl  0x5b74
     883:	e8 f2 2f 00 00       	call   387a <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    printf(1, "pipe() failed\n");
     ...
     91d:	68 6d 3e 00 00       	push   $0x3e6d
     922:	6a 01                	push   $0x1
     924:	e8 51 2f 00 00       	call   387a <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     983:	68 7c 3e 00 00       	push   $0x3e7c
     988:	6a 01                	push   $0x1
     98a:	e8 eb 2e 00 00       	call   387a <printf>
        exit();
    ...
    exit();
     ...
     99c:	68 8a 3e 00 00       	push   $0x3e8a
     9a1:	6a 01                	push   $0x1
     9a3:	e8 d2 2e 00 00       	call   387a <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     9f1:	68 af 3e 00 00       	push   $0x3eaf
     9f6:	6a 01                	push   $0x1
     9f8:	e8 7d 2e 00 00       	call   387a <printf>
     9fd:	83 c4 10             	add    $0x10,%esp
     a00:	eb a9                	jmp    9ab <pipe1+0x11e>
      printf(1, "pipe1 oops 3 total %d\n", total);
     a02:	83 ec 04             	sub    $0x4,%esp
     a05:	ff 75 d0             	pushl  -0x30(%ebp)
     a08:	68 98 3e 00 00       	push   $0x3e98
     a0d:	6a 01                	push   $0x1
     a0f:	e8 66 2e 00 00       	call   387a <printf>
      exit();
     a14:	e8 07 2d 00 00       	call   3720 <exit>
    printf(1, "fork() failed\n");
     a19:	83 ec 08             	sub    $0x8,%esp
     a1c:	68 b9 3e 00 00       	push   $0x3eb9
     a21:	6a 01                	push   $0x1
     a23:	e8 52 2e 00 00       	call   387a <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     a36:	68 c8 3e 00 00       	push   $0x3ec8
     a3b:	6a 01                	push   $0x1
     a3d:	e8 38 2e 00 00       	call   387a <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     a87:	6a 01                	push   $0x1
     a89:	68 8d 44 00 00       	push   $0x448d
     ...
     aa1:	68 d2 3e 00 00       	push   $0x3ed2
     aa6:	6a 01                	push   $0x1
     aa8:	e8 cd 2d 00 00       	call   387a <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aeb:	68 e6 3e 00 00       	push   $0x3ee6
     af0:	6a 01                	push   $0x1
     af2:	e8 83 2d 00 00       	call   387a <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b10:	68 f9 3e 00 00       	push   $0x3ef9
     b15:	6a 01                	push   $0x1
     b17:	e8 5e 2d 00 00       	call   387a <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b37:	68 02 3f 00 00       	push   $0x3f02
     b3c:	6a 01                	push   $0x1
     b3e:	e8 37 2d 00 00       	call   387a <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b55:	68 0b 3f 00 00       	push   $0x3f0b
     b5a:	6a 01                	push   $0x1
     b5c:	e8 19 2d 00 00       	call   387a <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
     ...
     b95:	68 75 4a 00 00       	push   $0x4a75
     b9a:	6a 01                	push   $0x1
     b9c:	e8 d9 2c 00 00       	call   387a <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bae:	68 17 3f 00 00       	push   $0x3f17
     bb3:	6a 01                	push   $0x1
     bb5:	e8 c0 2c 00 00       	call   387a <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bc7:	68 27 3f 00 00       	push   $0x3f27
     bcc:	6a 01                	push   $0x1
     bce:	e8 a7 2c 00 00       	call   387a <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     be1:	68 34 3f 00 00       	push   $0x3f34
     be6:	6a 01                	push   $0x1
     be8:	e8 8d 2c 00 00       	call   387a <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c17:	e8 87 2e 00 00       	call   3aa3 <malloc>
    ...
    while(m1){
     ...
     c2a:	53                   	push   %ebx
     c2b:	e8 b3 2d 00 00       	call   39e3 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     c41:	e8 5d 2e 00 00       	call   3aa3 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c50:	50                   	push   %eax
     c51:	e8 8d 2d 00 00       	call   39e3 <free>
    printf(1, "mem ok\n");
     c56:	83 c4 08             	add    $0x8,%esp
     c59:	68 58 3f 00 00       	push   $0x3f58
     c5e:	6a 01                	push   $0x1
     c60:	e8 15 2c 00 00       	call   387a <printf>
    exit();
     c65:	e8 b6 2a 00 00       	call   3720 <exit>
      printf(1, "couldn't allocate mem?!!\n");
     c6a:	83 ec 08             	sub    $0x8,%esp
     c6d:	68 3e 3f 00 00       	push   $0x3f3e
     c72:	6a 01                	push   $0x1
     c74:	e8 01 2c 00 00       	call   387a <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     c9c:	68 60 3f 00 00       	push   $0x3f60
     ca1:	6a 01                	push   $0x1
     ca3:	e8 d2 2b 00 00       	call   387a <printf>

  unlink("sharedfd");
     ca8:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
     caf:	e8 bc 2a 00 00       	call   3770 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     cb4:	83 c4 08             	add    $0x8,%esp
     cb7:	68 02 02 00 00       	push   $0x202
     cbc:	68 6f 3f 00 00       	push   $0x3f6f
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1d:	68 34 4c 00 00       	push   $0x4c34
     d22:	6a 01                	push   $0x1
     d24:	e8 51 2b 00 00       	call   387a <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3b:	68 60 4c 00 00       	push   $0x4c60
     d40:	6a 01                	push   $0x1
     d42:	e8 33 2b 00 00       	call   387a <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     d5f:	6a 00                	push   $0x0
     d61:	68 6f 3f 00 00       	push   $0x3f6f
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     da3:	68 80 4c 00 00       	push   $0x4c80
     da8:	6a 01                	push   $0x1
     daa:	e8 cb 2a 00 00       	call   387a <printf>
    return;
  ...
  unlink("sharedfd");
     dde:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e06:	68 78 3f 00 00       	push   $0x3f78
     e0b:	6a 01                	push   $0x1
     e0d:	e8 68 2a 00 00       	call   387a <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     e1d:	56                   	push   %esi
     e1e:	53                   	push   %ebx
     e1f:	68 85 3f 00 00       	push   $0x3f85
     e24:	6a 01                	push   $0x1
     e26:	e8 4f 2a 00 00       	call   387a <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     e39:	c7 45 d8 9a 3f 00 00 	movl   $0x3f9a,-0x28(%ebp)
     e40:	c7 45 dc e3 40 00 00 	movl   $0x40e3,-0x24(%ebp)
     e47:	c7 45 e0 e7 40 00 00 	movl   $0x40e7,-0x20(%ebp)
     e4e:	c7 45 e4 9d 3f 00 00 	movl   $0x3f9d,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
     e55:	68 a0 3f 00 00       	push   $0x3fa0
     e5a:	6a 01                	push   $0x1
     e5c:	e8 19 2a 00 00       	call   387a <printf>
  ...
  for(pi = 0; pi < 4; pi++){
     ...
     e97:	68 75 4a 00 00       	push   $0x4a75
     e9c:	6a 01                	push   $0x1
     e9e:	e8 d7 29 00 00       	call   387a <printf>
      exit();
     ...
     edf:	68 3b 42 00 00       	push   $0x423b
     ee4:	6a 01                	push   $0x1
     ee6:	e8 8f 29 00 00       	call   387a <printf>
        exit();
     ...
     f1d:	50                   	push   %eax
     f1e:	68 b0 3f 00 00       	push   $0x3fb0
     f23:	6a 01                	push   $0x1
     f25:	e8 50 29 00 00       	call   387a <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4d:	68 c1 3f 00 00       	push   $0x3fc1
     f52:	6a 01                	push   $0x1
     f54:	e8 21 29 00 00       	call   387a <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fe9:	56                   	push   %esi
     fea:	68 cd 3f 00 00       	push   $0x3fcd
     fef:	6a 01                	push   $0x1
     ff1:	e8 84 28 00 00       	call   387a <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
     ...
     ffe:	68 de 3f 00 00       	push   $0x3fde
    1003:	6a 01                	push   $0x1
    1005:	e8 70 28 00 00       	call   387a <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    101d:	68 ec 3f 00 00       	push   $0x3fec
    1022:	6a 01                	push   $0x1
    1024:	e8 51 28 00 00       	call   387a <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	68 75 4a 00 00       	push   $0x4a75
    1056:	6a 01                	push   $0x1
    1058:	e8 1d 28 00 00       	call   387a <printf>
      exit();
    ...
    1071:	68 3b 42 00 00       	push   $0x423b
    1076:	6a 01                	push   $0x1
    1078:	e8 fd 27 00 00       	call   387a <printf>
          exit();
    ...
    10e2:	68 ed 3b 00 00       	push   $0x3bed
    10e7:	6a 01                	push   $0x1
    10e9:	e8 8c 27 00 00       	call   387a <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    116c:	50                   	push   %eax
    116d:	68 ac 4c 00 00       	push   $0x4cac
    1172:	6a 01                	push   $0x1
    1174:	e8 01 27 00 00       	call   387a <printf>
        exit();
    ...
    1188:	50                   	push   %eax
    1189:	68 d0 4c 00 00       	push   $0x4cd0
    118e:	6a 01                	push   $0x1
    1190:	e8 e5 26 00 00       	call   387a <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	68 ff 3f 00 00       	push   $0x3fff
    11fb:	6a 01                	push   $0x1
    11fd:	e8 78 26 00 00       	call   387a <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1214:	68 10 40 00 00       	push   $0x4010
    1219:	6a 01                	push   $0x1
    121b:	e8 5a 26 00 00       	call   387a <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1220:	83 c4 08             	add    $0x8,%esp
    1223:	68 02 02 00 00       	push   $0x202
    1228:	68 21 40 00 00       	push   $0x4021
  ...
  write(fd, "hello", 5);
    ...
    1242:	6a 05                	push   $0x5
    1244:	68 46 40 00 00       	push   $0x4046
    1249:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    125a:	6a 02                	push   $0x2
    125c:	68 21 40 00 00       	push   $0x4021
  ...
  if(unlink("unlinkread") != 0){
    ...
    1276:	68 21 40 00 00       	push   $0x4021
  ...
  unlink("unlinkread");
    1308:	c7 04 24 21 40 00 00 	movl   $0x4021,(%esp)
    130f:	e8 5c 24 00 00       	call   3770 <unlink>
  printf(1, "unlinkread ok\n");
    1314:	83 c4 08             	add    $0x8,%esp
    1317:	68 c9 40 00 00       	push   $0x40c9
    131c:	6a 01                	push   $0x1
    131e:	e8 57 25 00 00       	call   387a <printf>
}
    ...
    1330:	68 2c 40 00 00       	push   $0x402c
    1335:	6a 01                	push   $0x1
    1337:	e8 3e 25 00 00       	call   387a <printf>
    exit();
    133c:	e8 df 23 00 00       	call   3720 <exit>
    printf(1, "open unlinkread failed\n");
    1341:	83 ec 08             	sub    $0x8,%esp
    1344:	68 4c 40 00 00       	push   $0x404c
    1349:	6a 01                	push   $0x1
    134b:	e8 2a 25 00 00       	call   387a <printf>
    exit();
    1350:	e8 cb 23 00 00       	call   3720 <exit>
    printf(1, "unlink unlinkread failed\n");
    1355:	83 ec 08             	sub    $0x8,%esp
    1358:	68 64 40 00 00       	push   $0x4064
    135d:	6a 01                	push   $0x1
    135f:	e8 16 25 00 00       	call   387a <printf>
    exit();
    1364:	e8 b7 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread read failed");
    1369:	83 ec 08             	sub    $0x8,%esp
    136c:	68 82 40 00 00       	push   $0x4082
    1371:	6a 01                	push   $0x1
    1373:	e8 02 25 00 00       	call   387a <printf>
    exit();
    1378:	e8 a3 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread wrong data\n");
    137d:	83 ec 08             	sub    $0x8,%esp
    1380:	68 99 40 00 00       	push   $0x4099
    1385:	6a 01                	push   $0x1
    1387:	e8 ee 24 00 00       	call   387a <printf>
    exit();
    138c:	e8 8f 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread write failed\n");
    1391:	83 ec 08             	sub    $0x8,%esp
    1394:	68 b0 40 00 00       	push   $0x40b0
    1399:	6a 01                	push   $0x1
    139b:	e8 da 24 00 00       	call   387a <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    13ac:	68 d8 40 00 00       	push   $0x40d8
    13b1:	6a 01                	push   $0x1
    13b3:	e8 c2 24 00 00       	call   387a <printf>

  unlink("lf1");
    13b8:	c7 04 24 e2 40 00 00 	movl   $0x40e2,(%esp)
    13bf:	e8 ac 23 00 00       	call   3770 <unlink>
  unlink("lf2");
    13c4:	c7 04 24 e6 40 00 00 	movl   $0x40e6,(%esp)
    13cb:	e8 a0 23 00 00       	call   3770 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    13d0:	83 c4 08             	add    $0x8,%esp
    13d3:	68 02 02 00 00       	push   $0x202
    13d8:	68 e2 40 00 00       	push   $0x40e2
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    13f2:	6a 05                	push   $0x5
    13f4:	68 46 40 00 00       	push   $0x4046
    13f9:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1417:	68 e6 40 00 00       	push   $0x40e6
    141c:	68 e2 40 00 00       	push   $0x40e2
  ...
  unlink("lf1");
    ...
    1434:	68 e2 40 00 00       	push   $0x40e2
    1439:	e8 32 23 00 00       	call   3770 <unlink>

  if(open("lf1", 0) >= 0){
    143e:	83 c4 08             	add    $0x8,%esp
    1441:	6a 00                	push   $0x0
    1443:	68 e2 40 00 00       	push   $0x40e2
  ...
  fd = open("lf2", 0);
    ...
    145b:	6a 00                	push   $0x0
    145d:	68 e6 40 00 00       	push   $0x40e6
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    14a4:	68 e6 40 00 00       	push   $0x40e6
  ...
  unlink("lf2");
    ...
    14bc:	68 e6 40 00 00       	push   $0x40e6
    14c1:	e8 aa 22 00 00       	call   3770 <unlink>
  if(link("lf2", "lf1") >= 0){
    14c6:	83 c4 08             	add    $0x8,%esp
    14c9:	68 e2 40 00 00       	push   $0x40e2
    14ce:	68 e6 40 00 00       	push   $0x40e6
  ...
  if(link(".", "lf1") >= 0){
    ...
    14e6:	68 e2 40 00 00       	push   $0x40e2
    14eb:	68 aa 43 00 00       	push   $0x43aa
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	68 80 41 00 00       	push   $0x4180
    1508:	6a 01                	push   $0x1
    150a:	e8 6b 23 00 00       	call   387a <printf>
}
    ...
    151a:	68 ea 40 00 00       	push   $0x40ea
    151f:	6a 01                	push   $0x1
    1521:	e8 54 23 00 00       	call   387a <printf>
    exit();
    1526:	e8 f5 21 00 00       	call   3720 <exit>
    printf(1, "write lf1 failed\n");
    152b:	83 ec 08             	sub    $0x8,%esp
    152e:	68 fd 40 00 00       	push   $0x40fd
    1533:	6a 01                	push   $0x1
    1535:	e8 40 23 00 00       	call   387a <printf>
    exit();
    153a:	e8 e1 21 00 00       	call   3720 <exit>
    printf(1, "link lf1 lf2 failed\n");
    153f:	83 ec 08             	sub    $0x8,%esp
    1542:	68 0f 41 00 00       	push   $0x410f
    1547:	6a 01                	push   $0x1
    1549:	e8 2c 23 00 00       	call   387a <printf>
    exit();
    154e:	e8 cd 21 00 00       	call   3720 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1553:	83 ec 08             	sub    $0x8,%esp
    1556:	68 f0 4c 00 00       	push   $0x4cf0
    155b:	6a 01                	push   $0x1
    155d:	e8 18 23 00 00       	call   387a <printf>
    exit();
    1562:	e8 b9 21 00 00       	call   3720 <exit>
    printf(1, "open lf2 failed\n");
    1567:	83 ec 08             	sub    $0x8,%esp
    156a:	68 24 41 00 00       	push   $0x4124
    156f:	6a 01                	push   $0x1
    1571:	e8 04 23 00 00       	call   387a <printf>
    exit();
    1576:	e8 a5 21 00 00       	call   3720 <exit>
    printf(1, "read lf2 failed\n");
    157b:	83 ec 08             	sub    $0x8,%esp
    157e:	68 35 41 00 00       	push   $0x4135
    1583:	6a 01                	push   $0x1
    1585:	e8 f0 22 00 00       	call   387a <printf>
    exit();
    158a:	e8 91 21 00 00       	call   3720 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    158f:	83 ec 08             	sub    $0x8,%esp
    1592:	68 46 41 00 00       	push   $0x4146
    1597:	6a 01                	push   $0x1
    1599:	e8 dc 22 00 00       	call   387a <printf>
    exit();
    159e:	e8 7d 21 00 00       	call   3720 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    15a3:	83 ec 08             	sub    $0x8,%esp
    15a6:	68 18 4d 00 00       	push   $0x4d18
    15ab:	6a 01                	push   $0x1
    15ad:	e8 c8 22 00 00       	call   387a <printf>
    exit();
    15b2:	e8 69 21 00 00       	call   3720 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    15b7:	83 ec 08             	sub    $0x8,%esp
    15ba:	68 64 41 00 00       	push   $0x4164
    15bf:	6a 01                	push   $0x1
    15c1:	e8 b4 22 00 00       	call   387a <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    15d4:	68 8d 41 00 00       	push   $0x418d
    15d9:	6a 01                	push   $0x1
    15db:	e8 9a 22 00 00       	call   387a <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16a3:	50                   	push   %eax
    16a4:	68 9d 41 00 00       	push   $0x419d
    ...
    16b9:	50                   	push   %eax
    16ba:	68 9d 41 00 00       	push   $0x419d
    ...
    16d2:	50                   	push   %eax
    16d3:	68 a0 41 00 00       	push   $0x41a0
    16d8:	6a 01                	push   $0x1
    16da:	e8 9b 21 00 00       	call   387a <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    16fc:	6a 00                	push   $0x0
    16fe:	68 aa 43 00 00       	push   $0x43aa
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    175e:	50                   	push   %eax
    175f:	68 bc 41 00 00       	push   $0x41bc
    1764:	6a 01                	push   $0x1
    1766:	e8 0f 21 00 00       	call   387a <printf>
        exit();
    ...
    1776:	50                   	push   %eax
    1777:	68 d5 41 00 00       	push   $0x41d5
    177c:	6a 01                	push   $0x1
    177e:	e8 f7 20 00 00       	call   387a <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	68 3c 4d 00 00       	push   $0x4d3c
    17ab:	6a 01                	push   $0x1
    17ad:	e8 c8 20 00 00       	call   387a <printf>
    exit();
    ...
    17ba:	68 75 4a 00 00       	push   $0x4a75
    17bf:	6a 01                	push   $0x1
    17c1:	e8 b4 20 00 00       	call   387a <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	68 f2 41 00 00       	push   $0x41f2
    18a7:	6a 01                	push   $0x1
    18a9:	e8 cc 1f 00 00       	call   387a <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    18c2:	68 00 42 00 00       	push   $0x4200
    18c7:	6a 01                	push   $0x1
    18c9:	e8 ac 1f 00 00       	call   387a <printf>

  unlink("x");
    18ce:	c7 04 24 8d 44 00 00 	movl   $0x448d,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18fb:	68 75 4a 00 00       	push   $0x4a75
    1900:	6a 01                	push   $0x1
    1902:	e8 73 1f 00 00       	call   387a <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    191b:	68 8d 44 00 00       	push   $0x448d
  ...
  for(i = 0; i < 100; i++){
    ...
    1960:	68 8d 44 00 00       	push   $0x448d
    ...
    1972:	68 8d 44 00 00       	push   $0x448d
    1977:	68 11 42 00 00       	push   $0x4211
  ...
  printf(1, "linkunlink ok\n");
    ...
    1992:	68 15 42 00 00       	push   $0x4215
    1997:	6a 01                	push   $0x1
    1999:	e8 dc 1e 00 00       	call   387a <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    19b2:	68 24 42 00 00       	push   $0x4224
    19b7:	6a 01                	push   $0x1
    19b9:	e8 bc 1e 00 00       	call   387a <printf>
  unlink("bd");
    19be:	c7 04 24 31 42 00 00 	movl   $0x4231,(%esp)
    19c5:	e8 a6 1d 00 00       	call   3770 <unlink>

  fd = open("bd", O_CREATE);
    19ca:	83 c4 08             	add    $0x8,%esp
    19cd:	68 00 02 00 00       	push   $0x200
    19d2:	68 31 42 00 00       	push   $0x4231
  ...
  for(i = 0; i < 500; i++){
    ...
    1a31:	50                   	push   %eax
    1a32:	68 31 42 00 00       	push   $0x4231
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4b:	68 34 42 00 00       	push   $0x4234
    1a50:	6a 01                	push   $0x1
    1a52:	e8 23 1e 00 00       	call   387a <printf>
    exit();
    1a57:	e8 c4 1c 00 00       	call   3720 <exit>
      printf(1, "bigdir link failed\n");
    1a5c:	83 ec 08             	sub    $0x8,%esp
    1a5f:	68 4a 42 00 00       	push   $0x424a
    1a64:	6a 01                	push   $0x1
    1a66:	e8 0f 1e 00 00       	call   387a <printf>
      exit();
  ...
  unlink("bd");
    ...
    1a73:	68 31 42 00 00       	push   $0x4231
  ...
  for(i = 0; i < 500; i++){
    ...
    1ad7:	68 5e 42 00 00       	push   $0x425e
    1adc:	6a 01                	push   $0x1
    1ade:	e8 97 1d 00 00       	call   387a <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1aeb:	68 73 42 00 00       	push   $0x4273
    1af0:	6a 01                	push   $0x1
    1af2:	e8 83 1d 00 00       	call   387a <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1b06:	68 7e 42 00 00       	push   $0x427e
    1b0b:	6a 01                	push   $0x1
    1b0d:	e8 68 1d 00 00       	call   387a <printf>

  unlink("ff");
    1b12:	c7 04 24 07 43 00 00 	movl   $0x4307,(%esp)
    1b19:	e8 52 1c 00 00       	call   3770 <unlink>
  if(mkdir("dd") != 0){
    1b1e:	c7 04 24 a4 43 00 00 	movl   $0x43a4,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b3d:	68 dd 42 00 00       	push   $0x42dd
  ...
  write(fd, "ff", 2);
    ...
    1b57:	6a 02                	push   $0x2
    1b59:	68 07 43 00 00       	push   $0x4307
    1b5e:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1b6c:	c7 04 24 a4 43 00 00 	movl   $0x43a4,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1b86:	68 b8 42 00 00       	push   $0x42b8
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ba3:	68 da 42 00 00       	push   $0x42da
  ...
  write(fd, "FF", 2);
    ...
    1bbd:	6a 02                	push   $0x2
    1bbf:	68 fb 42 00 00       	push   $0x42fb
    1bc4:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1bd5:	6a 00                	push   $0x0
    1bd7:	68 fe 42 00 00       	push   $0x42fe
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    1c26:	68 3e 43 00 00       	push   $0x433e
    1c2b:	68 da 42 00 00       	push   $0x42da
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c43:	68 da 42 00 00       	push   $0x42da
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c5b:	6a 00                	push   $0x0
    1c5d:	68 da 42 00 00       	push   $0x42da
  ...
  if(chdir("dd") != 0){
    ...
    1c75:	68 a4 43 00 00       	push   $0x43a4
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1c8d:	68 72 43 00 00       	push   $0x4372
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ca5:	68 98 43 00 00       	push   $0x4398
  ...
  if(chdir("./..") != 0){
    ...
    1cbd:	68 a7 43 00 00       	push   $0x43a7
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cd5:	6a 00                	push   $0x0
    1cd7:	68 3e 43 00 00       	push   $0x433e
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d19:	6a 00                	push   $0x0
    1d1b:	68 da 42 00 00       	push   $0x42da
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d38:	68 f2 43 00 00       	push   $0x43f2
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d55:	68 17 44 00 00       	push   $0x4417
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d72:	68 a4 43 00 00       	push   $0x43a4
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1d8a:	6a 02                	push   $0x2
    1d8c:	68 a4 43 00 00       	push   $0x43a4
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1da4:	6a 01                	push   $0x1
    1da6:	68 a4 43 00 00       	push   $0x43a4
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1dbe:	68 86 44 00 00       	push   $0x4486
    1dc3:	68 f2 43 00 00       	push   $0x43f2
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ddb:	68 86 44 00 00       	push   $0x4486
    1de0:	68 17 44 00 00       	push   $0x4417
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1df8:	68 3e 43 00 00       	push   $0x433e
    1dfd:	68 dd 42 00 00       	push   $0x42dd
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e15:	68 f2 43 00 00       	push   $0x43f2
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e2d:	68 17 44 00 00       	push   $0x4417
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e45:	68 3e 43 00 00       	push   $0x433e
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e5d:	68 17 44 00 00       	push   $0x4417
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e75:	68 f2 43 00 00       	push   $0x43f2
  ...
  if(chdir("dd/ff") == 0){
    ...
    1e8d:	68 dd 42 00 00       	push   $0x42dd
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ea5:	68 89 44 00 00       	push   $0x4489
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ebd:	68 3e 43 00 00       	push   $0x433e
  ...
  if(unlink("dd/ff") != 0){
    ...
    1ed5:	68 dd 42 00 00       	push   $0x42dd
  ...
  if(unlink("dd") == 0){
    ...
    1eed:	68 a4 43 00 00       	push   $0x43a4
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f05:	68 b9 42 00 00       	push   $0x42b9
  ...
  if(unlink("dd") < 0){
    ...
    1f1d:	68 a4 43 00 00       	push   $0x43a4
  ...
  printf(1, "subdir ok\n");
    ...
    1f35:	68 86 45 00 00       	push   $0x4586
    1f3a:	6a 01                	push   $0x1
    1f3c:	e8 39 19 00 00       	call   387a <printf>
}
    ...
    1f4c:	68 8b 42 00 00       	push   $0x428b
    1f51:	6a 01                	push   $0x1
    1f53:	e8 22 19 00 00       	call   387a <printf>
    exit();
    1f58:	e8 c3 17 00 00       	call   3720 <exit>
    printf(1, "create dd/ff failed\n");
    1f5d:	83 ec 08             	sub    $0x8,%esp
    1f60:	68 a3 42 00 00       	push   $0x42a3
    1f65:	6a 01                	push   $0x1
    1f67:	e8 0e 19 00 00       	call   387a <printf>
    exit();
    1f6c:	e8 af 17 00 00       	call   3720 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1f71:	83 ec 08             	sub    $0x8,%esp
    1f74:	68 70 4d 00 00       	push   $0x4d70
    1f79:	6a 01                	push   $0x1
    1f7b:	e8 fa 18 00 00       	call   387a <printf>
    exit();
    1f80:	e8 9b 17 00 00       	call   3720 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    1f85:	83 ec 08             	sub    $0x8,%esp
    1f88:	68 bf 42 00 00       	push   $0x42bf
    1f8d:	6a 01                	push   $0x1
    1f8f:	e8 e6 18 00 00       	call   387a <printf>
    exit();
    1f94:	e8 87 17 00 00       	call   3720 <exit>
    printf(1, "create dd/dd/ff failed\n");
    1f99:	83 ec 08             	sub    $0x8,%esp
    1f9c:	68 e3 42 00 00       	push   $0x42e3
    1fa1:	6a 01                	push   $0x1
    1fa3:	e8 d2 18 00 00       	call   387a <printf>
    exit();
    1fa8:	e8 73 17 00 00       	call   3720 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1fad:	83 ec 08             	sub    $0x8,%esp
    1fb0:	68 0a 43 00 00       	push   $0x430a
    1fb5:	6a 01                	push   $0x1
    1fb7:	e8 be 18 00 00       	call   387a <printf>
    exit();
    1fbc:	e8 5f 17 00 00       	call   3720 <exit>
    printf(1, "dd/dd/../ff wrong content\n");
    1fc1:	83 ec 08             	sub    $0x8,%esp
    1fc4:	68 23 43 00 00       	push   $0x4323
    1fc9:	6a 01                	push   $0x1
    1fcb:	e8 aa 18 00 00       	call   387a <printf>
    exit();
    1fd0:	e8 4b 17 00 00       	call   3720 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1fd5:	83 ec 08             	sub    $0x8,%esp
    1fd8:	68 98 4d 00 00       	push   $0x4d98
    1fdd:	6a 01                	push   $0x1
    1fdf:	e8 96 18 00 00       	call   387a <printf>
    exit();
    1fe4:	e8 37 17 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1fe9:	83 ec 08             	sub    $0x8,%esp
    1fec:	68 49 43 00 00       	push   $0x4349
    1ff1:	6a 01                	push   $0x1
    1ff3:	e8 82 18 00 00       	call   387a <printf>
    exit();
    1ff8:	e8 23 17 00 00       	call   3720 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    1ffd:	83 ec 08             	sub    $0x8,%esp
    2000:	68 bc 4d 00 00       	push   $0x4dbc
    2005:	6a 01                	push   $0x1
    2007:	e8 6e 18 00 00       	call   387a <printf>
    exit();
    200c:	e8 0f 17 00 00       	call   3720 <exit>
    printf(1, "chdir dd failed\n");
    2011:	83 ec 08             	sub    $0x8,%esp
    2014:	68 61 43 00 00       	push   $0x4361
    2019:	6a 01                	push   $0x1
    201b:	e8 5a 18 00 00       	call   387a <printf>
    exit();
    2020:	e8 fb 16 00 00       	call   3720 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2025:	83 ec 08             	sub    $0x8,%esp
    2028:	68 7e 43 00 00       	push   $0x437e
    202d:	6a 01                	push   $0x1
    202f:	e8 46 18 00 00       	call   387a <printf>
    exit();
    2034:	e8 e7 16 00 00       	call   3720 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2039:	83 ec 08             	sub    $0x8,%esp
    203c:	68 7e 43 00 00       	push   $0x437e
    2041:	6a 01                	push   $0x1
    2043:	e8 32 18 00 00       	call   387a <printf>
    exit();
    2048:	e8 d3 16 00 00       	call   3720 <exit>
    printf(1, "chdir ./.. failed\n");
    204d:	83 ec 08             	sub    $0x8,%esp
    2050:	68 ac 43 00 00       	push   $0x43ac
    2055:	6a 01                	push   $0x1
    2057:	e8 1e 18 00 00       	call   387a <printf>
    exit();
    205c:	e8 bf 16 00 00       	call   3720 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    2061:	83 ec 08             	sub    $0x8,%esp
    2064:	68 bf 43 00 00       	push   $0x43bf
    2069:	6a 01                	push   $0x1
    206b:	e8 0a 18 00 00       	call   387a <printf>
    exit();
    2070:	e8 ab 16 00 00       	call   3720 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    2075:	83 ec 08             	sub    $0x8,%esp
    2078:	68 d7 43 00 00       	push   $0x43d7
    207d:	6a 01                	push   $0x1
    207f:	e8 f6 17 00 00       	call   387a <printf>
    exit();
    2084:	e8 97 16 00 00       	call   3720 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2089:	83 ec 08             	sub    $0x8,%esp
    208c:	68 e0 4d 00 00       	push   $0x4de0
    2091:	6a 01                	push   $0x1
    2093:	e8 e2 17 00 00       	call   387a <printf>
    exit();
    2098:	e8 83 16 00 00       	call   3720 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    209d:	83 ec 08             	sub    $0x8,%esp
    20a0:	68 fb 43 00 00       	push   $0x43fb
    20a5:	6a 01                	push   $0x1
    20a7:	e8 ce 17 00 00       	call   387a <printf>
    exit();
    20ac:	e8 6f 16 00 00       	call   3720 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    20b1:	83 ec 08             	sub    $0x8,%esp
    20b4:	68 20 44 00 00       	push   $0x4420
    20b9:	6a 01                	push   $0x1
    20bb:	e8 ba 17 00 00       	call   387a <printf>
    exit();
    20c0:	e8 5b 16 00 00       	call   3720 <exit>
    printf(1, "create dd succeeded!\n");
    20c5:	83 ec 08             	sub    $0x8,%esp
    20c8:	68 3c 44 00 00       	push   $0x443c
    20cd:	6a 01                	push   $0x1
    20cf:	e8 a6 17 00 00       	call   387a <printf>
    exit();
    20d4:	e8 47 16 00 00       	call   3720 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    20d9:	83 ec 08             	sub    $0x8,%esp
    20dc:	68 52 44 00 00       	push   $0x4452
    20e1:	6a 01                	push   $0x1
    20e3:	e8 92 17 00 00       	call   387a <printf>
    exit();
    20e8:	e8 33 16 00 00       	call   3720 <exit>
    printf(1, "open dd wronly succeeded!\n");
    20ed:	83 ec 08             	sub    $0x8,%esp
    20f0:	68 6b 44 00 00       	push   $0x446b
    20f5:	6a 01                	push   $0x1
    20f7:	e8 7e 17 00 00       	call   387a <printf>
    exit();
    20fc:	e8 1f 16 00 00       	call   3720 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2101:	83 ec 08             	sub    $0x8,%esp
    2104:	68 08 4e 00 00       	push   $0x4e08
    2109:	6a 01                	push   $0x1
    210b:	e8 6a 17 00 00       	call   387a <printf>
    exit();
    2110:	e8 0b 16 00 00       	call   3720 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2115:	83 ec 08             	sub    $0x8,%esp
    2118:	68 2c 4e 00 00       	push   $0x4e2c
    211d:	6a 01                	push   $0x1
    211f:	e8 56 17 00 00       	call   387a <printf>
    exit();
    2124:	e8 f7 15 00 00       	call   3720 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2129:	83 ec 08             	sub    $0x8,%esp
    212c:	68 50 4e 00 00       	push   $0x4e50
    2131:	6a 01                	push   $0x1
    2133:	e8 42 17 00 00       	call   387a <printf>
    exit();
    2138:	e8 e3 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    213d:	83 ec 08             	sub    $0x8,%esp
    2140:	68 8f 44 00 00       	push   $0x448f
    2145:	6a 01                	push   $0x1
    2147:	e8 2e 17 00 00       	call   387a <printf>
    exit();
    214c:	e8 cf 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    2151:	83 ec 08             	sub    $0x8,%esp
    2154:	68 aa 44 00 00       	push   $0x44aa
    2159:	6a 01                	push   $0x1
    215b:	e8 1a 17 00 00       	call   387a <printf>
    exit();
    2160:	e8 bb 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2165:	83 ec 08             	sub    $0x8,%esp
    2168:	68 c5 44 00 00       	push   $0x44c5
    216d:	6a 01                	push   $0x1
    216f:	e8 06 17 00 00       	call   387a <printf>
    exit();
    2174:	e8 a7 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2179:	83 ec 08             	sub    $0x8,%esp
    217c:	68 e2 44 00 00       	push   $0x44e2
    2181:	6a 01                	push   $0x1
    2183:	e8 f2 16 00 00       	call   387a <printf>
    exit();
    2188:	e8 93 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    218d:	83 ec 08             	sub    $0x8,%esp
    2190:	68 fe 44 00 00       	push   $0x44fe
    2195:	6a 01                	push   $0x1
    2197:	e8 de 16 00 00       	call   387a <printf>
    exit();
    219c:	e8 7f 15 00 00       	call   3720 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    21a1:	83 ec 08             	sub    $0x8,%esp
    21a4:	68 1a 45 00 00       	push   $0x451a
    21a9:	6a 01                	push   $0x1
    21ab:	e8 ca 16 00 00       	call   387a <printf>
    exit();
    21b0:	e8 6b 15 00 00       	call   3720 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    21b5:	83 ec 08             	sub    $0x8,%esp
    21b8:	68 32 45 00 00       	push   $0x4532
    21bd:	6a 01                	push   $0x1
    21bf:	e8 b6 16 00 00       	call   387a <printf>
    exit();
    21c4:	e8 57 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    21c9:	83 ec 08             	sub    $0x8,%esp
    21cc:	68 49 43 00 00       	push   $0x4349
    21d1:	6a 01                	push   $0x1
    21d3:	e8 a2 16 00 00       	call   387a <printf>
    exit();
    21d8:	e8 43 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/ff failed\n");
    21dd:	83 ec 08             	sub    $0x8,%esp
    21e0:	68 4a 45 00 00       	push   $0x454a
    21e5:	6a 01                	push   $0x1
    21e7:	e8 8e 16 00 00       	call   387a <printf>
    exit();
    21ec:	e8 2f 15 00 00       	call   3720 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    21f1:	83 ec 08             	sub    $0x8,%esp
    21f4:	68 74 4e 00 00       	push   $0x4e74
    21f9:	6a 01                	push   $0x1
    21fb:	e8 7a 16 00 00       	call   387a <printf>
    exit();
    2200:	e8 1b 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd failed\n");
    2205:	83 ec 08             	sub    $0x8,%esp
    2208:	68 5f 45 00 00       	push   $0x455f
    220d:	6a 01                	push   $0x1
    220f:	e8 66 16 00 00       	call   387a <printf>
    exit();
    2214:	e8 07 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd failed\n");
    2219:	83 ec 08             	sub    $0x8,%esp
    221c:	68 74 45 00 00       	push   $0x4574
    2221:	6a 01                	push   $0x1
    2223:	e8 52 16 00 00       	call   387a <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2236:	68 91 45 00 00       	push   $0x4591
    223b:	6a 01                	push   $0x1
    223d:	e8 38 16 00 00       	call   387a <printf>

  unlink("bigwrite");
    2242:	c7 04 24 a0 45 00 00 	movl   $0x45a0,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225b:	68 a9 45 00 00       	push   $0x45a9
    2260:	6a 01                	push   $0x1
    2262:	e8 13 16 00 00       	call   387a <printf>
      exit();
    ...
    226c:	50                   	push   %eax
    226d:	56                   	push   %esi
    226e:	68 c1 45 00 00       	push   $0x45c1
    2273:	6a 01                	push   $0x1
    2275:	e8 00 16 00 00       	call   387a <printf>
        exit();
    ...
    unlink("bigwrite");
    2288:	c7 04 24 a0 45 00 00 	movl   $0x45a0,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22ad:	68 a0 45 00 00       	push   $0x45a0
  ...
  printf(1, "bigwrite ok\n");
    ...
    22e8:	68 d3 45 00 00       	push   $0x45d3
    22ed:	6a 01                	push   $0x1
    22ef:	e8 86 15 00 00       	call   387a <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2308:	68 e0 45 00 00       	push   $0x45e0
    230d:	6a 01                	push   $0x1
    230f:	e8 66 15 00 00       	call   387a <printf>

  unlink("bigfile");
    2314:	c7 04 24 fc 45 00 00 	movl   $0x45fc,(%esp)
    231b:	e8 50 14 00 00       	call   3770 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2320:	83 c4 08             	add    $0x8,%esp
    2323:	68 02 02 00 00       	push   $0x202
    2328:	68 fc 45 00 00       	push   $0x45fc
  ...
  for(i = 0; i < 20; i++){
    ...
    2345:	68 ee 45 00 00       	push   $0x45ee
    234a:	6a 01                	push   $0x1
    234c:	e8 29 15 00 00       	call   387a <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2391:	68 04 46 00 00       	push   $0x4604
    2396:	6a 01                	push   $0x1
    2398:	e8 dd 14 00 00       	call   387a <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    23ae:	6a 00                	push   $0x0
    23b0:	68 fc 45 00 00       	push   $0x45fc
  ...
  for(i = 0; ; i++){
    ...
    241b:	68 1a 46 00 00       	push   $0x461a
    2420:	6a 01                	push   $0x1
    2422:	e8 53 14 00 00       	call   387a <printf>
    exit();
    2427:	e8 f4 12 00 00       	call   3720 <exit>
      printf(1, "read bigfile failed\n");
    242c:	83 ec 08             	sub    $0x8,%esp
    242f:	68 2f 46 00 00       	push   $0x462f
    2434:	6a 01                	push   $0x1
    2436:	e8 3f 14 00 00       	call   387a <printf>
      exit();
    243b:	e8 e0 12 00 00       	call   3720 <exit>
      printf(1, "short read bigfile\n");
    2440:	83 ec 08             	sub    $0x8,%esp
    2443:	68 44 46 00 00       	push   $0x4644
    2448:	6a 01                	push   $0x1
    244a:	e8 2b 14 00 00       	call   387a <printf>
      exit();
    244f:	e8 cc 12 00 00       	call   3720 <exit>
      printf(1, "read bigfile wrong data\n");
    2454:	83 ec 08             	sub    $0x8,%esp
    2457:	68 58 46 00 00       	push   $0x4658
    245c:	6a 01                	push   $0x1
    245e:	e8 17 14 00 00       	call   387a <printf>
      exit();
  ...
  unlink("bigfile");
    ...
    247f:	68 fc 45 00 00       	push   $0x45fc
    2484:	e8 e7 12 00 00       	call   3770 <unlink>

  printf(1, "bigfile test ok\n");
    2489:	83 c4 08             	add    $0x8,%esp
    248c:	68 8b 46 00 00       	push   $0x468b
    2491:	6a 01                	push   $0x1
    2493:	e8 e2 13 00 00       	call   387a <printf>
}
    ...
    24a6:	68 71 46 00 00       	push   $0x4671
    24ab:	6a 01                	push   $0x1
    24ad:	e8 c8 13 00 00       	call   387a <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    24bd:	68 9c 46 00 00       	push   $0x469c
    24c2:	6a 01                	push   $0x1
    24c4:	e8 b1 13 00 00       	call   387a <printf>

  if(mkdir("12345678901234") != 0){
    24c9:	c7 04 24 d7 46 00 00 	movl   $0x46d7,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24e3:	68 94 4e 00 00       	push   $0x4e94
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2500:	68 e4 4e 00 00       	push   $0x4ee4
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2521:	6a 00                	push   $0x0
    2523:	68 54 4f 00 00       	push   $0x4f54
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2541:	c7 04 24 c8 46 00 00 	movl   $0x46c8,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2557:	68 f0 4f 00 00       	push   $0x4ff0
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	68 e6 46 00 00       	push   $0x46e6
    2570:	6a 01                	push   $0x1
    2572:	e8 03 13 00 00       	call   387a <printf>
}
    ...
    257f:	68 ab 46 00 00       	push   $0x46ab
    2584:	6a 01                	push   $0x1
    2586:	e8 ef 12 00 00       	call   387a <printf>
    exit();
    258b:	e8 90 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2590:	83 ec 08             	sub    $0x8,%esp
    2593:	68 b4 4e 00 00       	push   $0x4eb4
    2598:	6a 01                	push   $0x1
    259a:	e8 db 12 00 00       	call   387a <printf>
    exit();
    259f:	e8 7c 11 00 00       	call   3720 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    25a4:	83 ec 08             	sub    $0x8,%esp
    25a7:	68 14 4f 00 00       	push   $0x4f14
    25ac:	6a 01                	push   $0x1
    25ae:	e8 c7 12 00 00       	call   387a <printf>
    exit();
    25b3:	e8 68 11 00 00       	call   3720 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    25b8:	83 ec 08             	sub    $0x8,%esp
    25bb:	68 84 4f 00 00       	push   $0x4f84
    25c0:	6a 01                	push   $0x1
    25c2:	e8 b3 12 00 00       	call   387a <printf>
    exit();
    25c7:	e8 54 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    25cc:	83 ec 08             	sub    $0x8,%esp
    25cf:	68 c0 4f 00 00       	push   $0x4fc0
    25d4:	6a 01                	push   $0x1
    25d6:	e8 9f 12 00 00       	call   387a <printf>
    exit();
    25db:	e8 40 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    25e0:	83 ec 08             	sub    $0x8,%esp
    25e3:	68 10 50 00 00       	push   $0x5010
    25e8:	6a 01                	push   $0x1
    25ea:	e8 8b 12 00 00       	call   387a <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    25fa:	68 f3 46 00 00       	push   $0x46f3
    25ff:	6a 01                	push   $0x1
    2601:	e8 74 12 00 00       	call   387a <printf>
  if(mkdir("dots") != 0){
    2606:	c7 04 24 ff 46 00 00 	movl   $0x46ff,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    2620:	68 ff 46 00 00       	push   $0x46ff
  ...
  if(unlink(".") == 0){
    ...
    2638:	68 aa 43 00 00       	push   $0x43aa
  ...
  if(unlink("..") == 0){
    ...
    2650:	68 a9 43 00 00       	push   $0x43a9
  ...
  if(chdir("/") != 0){
    ...
    2668:	68 7d 3b 00 00       	push   $0x3b7d
  ...
  if(unlink("dots/.") == 0){
    ...
    2680:	68 47 47 00 00       	push   $0x4747
  ...
  if(unlink("dots/..") == 0){
    ...
    2698:	68 65 47 00 00       	push   $0x4765
  ...
  if(unlink("dots") != 0){
    ...
    26b0:	68 ff 46 00 00       	push   $0x46ff
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	68 9a 47 00 00       	push   $0x479a
    26cd:	6a 01                	push   $0x1
    26cf:	e8 a6 11 00 00       	call   387a <printf>
}
    ...
    26dc:	68 04 47 00 00       	push   $0x4704
    26e1:	6a 01                	push   $0x1
    26e3:	e8 92 11 00 00       	call   387a <printf>
    exit();
    26e8:	e8 33 10 00 00       	call   3720 <exit>
    printf(1, "chdir dots failed\n");
    26ed:	83 ec 08             	sub    $0x8,%esp
    26f0:	68 17 47 00 00       	push   $0x4717
    26f5:	6a 01                	push   $0x1
    26f7:	e8 7e 11 00 00       	call   387a <printf>
    exit();
    26fc:	e8 1f 10 00 00       	call   3720 <exit>
    printf(1, "rm . worked!\n");
    2701:	83 ec 08             	sub    $0x8,%esp
    2704:	68 2a 47 00 00       	push   $0x472a
    2709:	6a 01                	push   $0x1
    270b:	e8 6a 11 00 00       	call   387a <printf>
    exit();
    2710:	e8 0b 10 00 00       	call   3720 <exit>
    printf(1, "rm .. worked!\n");
    2715:	83 ec 08             	sub    $0x8,%esp
    2718:	68 38 47 00 00       	push   $0x4738
    271d:	6a 01                	push   $0x1
    271f:	e8 56 11 00 00       	call   387a <printf>
    exit();
    2724:	e8 f7 0f 00 00       	call   3720 <exit>
    printf(1, "chdir / failed\n");
    2729:	83 ec 08             	sub    $0x8,%esp
    272c:	68 7f 3b 00 00       	push   $0x3b7f
    2731:	6a 01                	push   $0x1
    2733:	e8 42 11 00 00       	call   387a <printf>
    exit();
    2738:	e8 e3 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots/. worked!\n");
    273d:	83 ec 08             	sub    $0x8,%esp
    2740:	68 4e 47 00 00       	push   $0x474e
    2745:	6a 01                	push   $0x1
    2747:	e8 2e 11 00 00       	call   387a <printf>
    exit();
    274c:	e8 cf 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots/.. worked!\n");
    2751:	83 ec 08             	sub    $0x8,%esp
    2754:	68 6d 47 00 00       	push   $0x476d
    2759:	6a 01                	push   $0x1
    275b:	e8 1a 11 00 00       	call   387a <printf>
    exit();
    2760:	e8 bb 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots failed!\n");
    2765:	83 ec 08             	sub    $0x8,%esp
    2768:	68 85 47 00 00       	push   $0x4785
    276d:	6a 01                	push   $0x1
    276f:	e8 06 11 00 00       	call   387a <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2780:	68 a4 47 00 00       	push   $0x47a4
    2785:	6a 01                	push   $0x1
    2787:	e8 ee 10 00 00       	call   387a <printf>

  fd = open("dirfile", O_CREATE);
    278c:	83 c4 08             	add    $0x8,%esp
    278f:	68 00 02 00 00       	push   $0x200
    2794:	68 b1 47 00 00       	push   $0x47b1
  ...
  if(chdir("dirfile") == 0){
    27b2:	c7 04 24 b1 47 00 00 	movl   $0x47b1,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    27cc:	6a 00                	push   $0x0
    27ce:	68 ea 47 00 00       	push   $0x47ea
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27eb:	68 ea 47 00 00       	push   $0x47ea
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2803:	68 ea 47 00 00       	push   $0x47ea
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    281b:	68 ea 47 00 00       	push   $0x47ea
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2833:	68 ea 47 00 00       	push   $0x47ea
    2838:	68 4e 48 00 00       	push   $0x484e
  ...
  if(unlink("dirfile") != 0){
    ...
    2850:	68 b1 47 00 00       	push   $0x47b1
  ...
  fd = open(".", O_RDWR);
    ...
    2868:	6a 02                	push   $0x2
    286a:	68 aa 43 00 00       	push   $0x43aa
  ...
  printf(1, "dir vs file OK\n");
    ...
    28b7:	68 81 48 00 00       	push   $0x4881
    28bc:	6a 01                	push   $0x1
    28be:	e8 b7 0f 00 00       	call   387a <printf>
}
    ...
    28ce:	68 b9 47 00 00       	push   $0x47b9
    28d3:	6a 01                	push   $0x1
    28d5:	e8 a0 0f 00 00       	call   387a <printf>
    exit();
    28da:	e8 41 0e 00 00       	call   3720 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    28df:	83 ec 08             	sub    $0x8,%esp
    28e2:	68 d0 47 00 00       	push   $0x47d0
    28e7:	6a 01                	push   $0x1
    28e9:	e8 8c 0f 00 00       	call   387a <printf>
    exit();
    28ee:	e8 2d 0e 00 00       	call   3720 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    28f3:	83 ec 08             	sub    $0x8,%esp
    28f6:	68 f5 47 00 00       	push   $0x47f5
    28fb:	6a 01                	push   $0x1
    28fd:	e8 78 0f 00 00       	call   387a <printf>
    exit();
    2902:	e8 19 0e 00 00       	call   3720 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2907:	83 ec 08             	sub    $0x8,%esp
    290a:	68 f5 47 00 00       	push   $0x47f5
    290f:	6a 01                	push   $0x1
    2911:	e8 64 0f 00 00       	call   387a <printf>
    exit();
    2916:	e8 05 0e 00 00       	call   3720 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    291b:	83 ec 08             	sub    $0x8,%esp
    291e:	68 13 48 00 00       	push   $0x4813
    2923:	6a 01                	push   $0x1
    2925:	e8 50 0f 00 00       	call   387a <printf>
    exit();
    292a:	e8 f1 0d 00 00       	call   3720 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    292f:	83 ec 08             	sub    $0x8,%esp
    2932:	68 30 48 00 00       	push   $0x4830
    2937:	6a 01                	push   $0x1
    2939:	e8 3c 0f 00 00       	call   387a <printf>
    exit();
    293e:	e8 dd 0d 00 00       	call   3720 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2943:	83 ec 08             	sub    $0x8,%esp
    2946:	68 44 50 00 00       	push   $0x5044
    294b:	6a 01                	push   $0x1
    294d:	e8 28 0f 00 00       	call   387a <printf>
    exit();
    2952:	e8 c9 0d 00 00       	call   3720 <exit>
    printf(1, "unlink dirfile failed!\n");
    2957:	83 ec 08             	sub    $0x8,%esp
    295a:	68 55 48 00 00       	push   $0x4855
    295f:	6a 01                	push   $0x1
    2961:	e8 14 0f 00 00       	call   387a <printf>
    exit();
    2966:	e8 b5 0d 00 00       	call   3720 <exit>
    printf(1, "open . for writing succeeded!\n");
    296b:	83 ec 08             	sub    $0x8,%esp
    296e:	68 64 50 00 00       	push   $0x5064
    2973:	6a 01                	push   $0x1
    2975:	e8 00 0f 00 00       	call   387a <printf>
    exit();
    297a:	e8 a1 0d 00 00       	call   3720 <exit>
    printf(1, "write . succeeded!\n");
    297f:	83 ec 08             	sub    $0x8,%esp
    2982:	68 6d 48 00 00       	push   $0x486d
    2987:	6a 01                	push   $0x1
    2989:	e8 ec 0e 00 00       	call   387a <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    299a:	68 91 48 00 00       	push   $0x4891
    299f:	6a 01                	push   $0x1
    29a1:	e8 d4 0e 00 00       	call   387a <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	68 a8 48 00 00       	push   $0x48a8
    29b8:	6a 01                	push   $0x1
    29ba:	e8 bb 0e 00 00       	call   387a <printf>
      exit();
    ...
    29c7:	68 bc 48 00 00       	push   $0x48bc
    29cc:	6a 01                	push   $0x1
    29ce:	e8 a7 0e 00 00       	call   387a <printf>
      exit();
    ...
    29ec:	68 8c 44 00 00       	push   $0x448c
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2a08:	68 a2 48 00 00       	push   $0x48a2
    ...
    2a1c:	68 a2 48 00 00       	push   $0x48a2
    ...
    2a71:	68 8c 44 00 00       	push   $0x448c
  ...
  chdir("/");
    ...
    2a9a:	68 7d 3b 00 00       	push   $0x3b7d
    2a9f:	e8 ec 0c 00 00       	call   3790 <chdir>
  printf(1, "empty file name OK\n");
    2aa4:	83 c4 08             	add    $0x8,%esp
    2aa7:	68 d0 48 00 00       	push   $0x48d0
    2aac:	6a 01                	push   $0x1
    2aae:	e8 c7 0d 00 00       	call   387a <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2ac2:	68 e4 48 00 00       	push   $0x48e4
    2ac7:	6a 01                	push   $0x1
    2ac9:	e8 ac 0d 00 00       	call   387a <printf>
  ...
  for(; n > 0; n--){
    ...
    2b12:	68 84 50 00 00       	push   $0x5084
    2b17:	6a 01                	push   $0x1
    2b19:	e8 5c 0d 00 00       	call   387a <printf>
    exit();
    2b1e:	e8 fd 0b 00 00       	call   3720 <exit>
      printf(1, "wait stopped early\n");
    2b23:	83 ec 08             	sub    $0x8,%esp
    2b26:	68 ef 48 00 00       	push   $0x48ef
    2b2b:	6a 01                	push   $0x1
    2b2d:	e8 48 0d 00 00       	call   387a <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2b44:	68 16 49 00 00       	push   $0x4916
    2b49:	6a 01                	push   $0x1
    2b4b:	e8 2a 0d 00 00       	call   387a <printf>
}
    ...
    2b5b:	68 03 49 00 00       	push   $0x4903
    2b60:	6a 01                	push   $0x1
    2b62:	e8 13 0d 00 00       	call   387a <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2b75:	68 24 49 00 00       	push   $0x4924
    2b7a:	ff 35 74 5b 00 00    	pushl  0x5b74
    2b80:	e8 f5 0c 00 00       	call   387a <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd1:	56                   	push   %esi
    2bd2:	53                   	push   %ebx
    2bd3:	68 2f 49 00 00       	push   $0x492f
    2bd8:	ff 35 74 5b 00 00    	pushl  0x5b74
    2bde:	e8 97 0c 00 00       	call   387a <printf>
      exit();
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d50:	68 4a 49 00 00       	push   $0x494a
    2d55:	ff 35 74 5b 00 00    	pushl  0x5b74
    2d5b:	e8 1a 0b 00 00       	call   387a <printf>
    exit();
    2d60:	e8 bb 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d65:	83 ec 08             	sub    $0x8,%esp
    2d68:	68 61 49 00 00       	push   $0x4961
    2d6d:	ff 35 74 5b 00 00    	pushl  0x5b74
    2d73:	e8 02 0b 00 00       	call   387a <printf>
    exit();
    ...
    2d85:	68 a8 50 00 00       	push   $0x50a8
    2d8a:	ff 35 74 5b 00 00    	pushl  0x5b74
    2d90:	e8 e5 0a 00 00       	call   387a <printf>
    exit();
    2d95:	e8 86 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d9a:	83 ec 08             	sub    $0x8,%esp
    2d9d:	68 7d 49 00 00       	push   $0x497d
    2da2:	ff 35 74 5b 00 00    	pushl  0x5b74
    2da8:	e8 cd 0a 00 00       	call   387a <printf>
    exit();
    2dad:	e8 6e 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2db2:	50                   	push   %eax
    2db3:	53                   	push   %ebx
    2db4:	68 e8 50 00 00       	push   $0x50e8
    2db9:	ff 35 74 5b 00 00    	pushl  0x5b74
    2dbf:	e8 b6 0a 00 00       	call   387a <printf>
    exit();
    2dc4:	e8 57 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dc9:	56                   	push   %esi
    2dca:	53                   	push   %ebx
    2dcb:	68 20 51 00 00       	push   $0x5120
    2dd0:	ff 35 74 5b 00 00    	pushl  0x5b74
    2dd6:	e8 9f 0a 00 00       	call   387a <printf>
    exit();
    2ddb:	e8 40 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2de0:	83 ec 08             	sub    $0x8,%esp
    2de3:	68 48 51 00 00       	push   $0x5148
    2de8:	ff 35 74 5b 00 00    	pushl  0x5b74
    2dee:	e8 87 0a 00 00       	call   387a <printf>
    exit();
    2df3:	e8 28 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2df8:	50                   	push   %eax
    2df9:	53                   	push   %ebx
    2dfa:	68 78 51 00 00       	push   $0x5178
    2dff:	ff 35 74 5b 00 00    	pushl  0x5b74
    2e05:	e8 70 0a 00 00       	call   387a <printf>
    exit();
    2e0a:	e8 11 09 00 00       	call   3720 <exit>
      printf(stdout, "fork failed\n");
    2e0f:	83 ec 08             	sub    $0x8,%esp
    2e12:	68 75 4a 00 00       	push   $0x4a75
    2e17:	ff 35 74 5b 00 00    	pushl  0x5b74
    2e1d:	e8 58 0a 00 00       	call   387a <printf>
      exit();
    ...
    2e2a:	50                   	push   %eax
    2e2b:	53                   	push   %ebx
    2e2c:	68 98 49 00 00       	push   $0x4998
    2e31:	ff 35 74 5b 00 00    	pushl  0x5b74
    2e37:	e8 3e 0a 00 00       	call   387a <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2e65:	68 6d 3e 00 00       	push   $0x3e6d
    2e6a:	6a 01                	push   $0x1
    2e6c:	e8 09 0a 00 00       	call   387a <printf>
    exit();
    ...
    2e92:	6a 01                	push   $0x1
    2e94:	68 8d 44 00 00       	push   $0x448d
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f37:	68 cc 49 00 00       	push   $0x49cc
    2f3c:	ff 35 74 5b 00 00    	pushl  0x5b74
    2f42:	e8 33 09 00 00       	call   387a <printf>
}
    ...
    2f55:	68 b1 49 00 00       	push   $0x49b1
    2f5a:	ff 35 74 5b 00 00    	pushl  0x5b74
    2f60:	e8 15 09 00 00       	call   387a <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f90:	68 da 49 00 00       	push   $0x49da
    2f95:	ff 35 74 5b 00 00    	pushl  0x5b74
    2f9b:	e8 da 08 00 00       	call   387a <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fe1:	53                   	push   %ebx
    2fe2:	68 e9 49 00 00       	push   $0x49e9
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3004:	68 f4 49 00 00       	push   $0x49f4
    3009:	ff 35 74 5b 00 00    	pushl  0x5b74
    300f:	e8 66 08 00 00       	call   387a <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    301c:	68 0d 4a 00 00       	push   $0x4a0d
    3021:	ff 35 74 5b 00 00    	pushl  0x5b74
    3027:	e8 4e 08 00 00       	call   387a <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    303c:	68 1a 4a 00 00       	push   $0x4a1a
    3041:	ff 35 74 5b 00 00    	pushl  0x5b74
    3047:	e8 2e 08 00 00       	call   387a <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    306c:	68 24 4a 00 00       	push   $0x4a24
    3071:	ff 35 74 5b 00 00    	pushl  0x5b74
    3077:	e8 fe 07 00 00       	call   387a <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3084:	68 35 4a 00 00       	push   $0x4a35
    3089:	ff 35 74 5b 00 00    	pushl  0x5b74
    308f:	e8 e6 07 00 00       	call   387a <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    309f:	68 42 4a 00 00       	push   $0x4a42
  ...
  fd = open("bigarg-ok", 0);
    ...
    30c5:	6a 00                	push   $0x0
    30c7:	68 42 4a 00 00       	push   $0x4a42
  ...
  unlink("bigarg-ok");
    30e5:	c7 04 24 42 4a 00 00 	movl   $0x4a42,(%esp)
    ...
    30f6:	c7 04 85 a0 5b 00 00 	movl   $0x519c,0x5ba0(,%eax,4)
    30fd:	9c 51 00 00 
    ...
    3116:	68 4c 4a 00 00       	push   $0x4a4c
    311b:	ff 35 74 5b 00 00    	pushl  0x5b74
    3121:	e8 54 07 00 00       	call   387a <printf>
    exec("echo", args);
    3126:	83 c4 08             	add    $0x8,%esp
    3129:	68 a0 5b 00 00       	push   $0x5ba0
    312e:	68 19 3c 00 00       	push   $0x3c19
    3133:	e8 20 06 00 00       	call   3758 <exec>
    printf(stdout, "bigarg test ok\n");
    3138:	83 c4 08             	add    $0x8,%esp
    313b:	68 59 4a 00 00       	push   $0x4a59
    3140:	ff 35 74 5b 00 00    	pushl  0x5b74
    3146:	e8 2f 07 00 00       	call   387a <printf>
    fd = open("bigarg-ok", O_CREATE);
    314b:	83 c4 08             	add    $0x8,%esp
    314e:	68 00 02 00 00       	push   $0x200
    3153:	68 42 4a 00 00       	push   $0x4a42
    ...
    316d:	68 69 4a 00 00       	push   $0x4a69
    3172:	ff 35 74 5b 00 00    	pushl  0x5b74
    3178:	e8 fd 06 00 00       	call   387a <printf>
    exit();
    317d:	e8 9e 05 00 00       	call   3720 <exit>
    printf(stdout, "bigarg test failed!\n");
    3182:	83 ec 08             	sub    $0x8,%esp
    3185:	68 82 4a 00 00       	push   $0x4a82
    318a:	ff 35 74 5b 00 00    	pushl  0x5b74
    3190:	e8 e5 06 00 00       	call   387a <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    31a3:	68 97 4a 00 00       	push   $0x4a97
    31a8:	6a 01                	push   $0x1
    31aa:	e8 cb 06 00 00       	call   387a <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3241:	56                   	push   %esi
    3242:	68 a4 4a 00 00       	push   $0x4aa4
    3247:	6a 01                	push   $0x1
    3249:	e8 2c 06 00 00       	call   387a <printf>
    ...
    326b:	50                   	push   %eax
    326c:	68 b0 4a 00 00       	push   $0x4ab0
    3271:	6a 01                	push   $0x1
    3273:	e8 02 06 00 00       	call   387a <printf>
      break;
    ...
    32a9:	57                   	push   %edi
    32aa:	68 c0 4a 00 00       	push   $0x4ac0
    32af:	6a 01                	push   $0x1
    32b1:	e8 c4 05 00 00       	call   387a <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3372:	68 d0 4a 00 00       	push   $0x4ad0
    3377:	6a 01                	push   $0x1
    3379:	e8 fc 04 00 00       	call   387a <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    338f:	68 e6 4a 00 00       	push   $0x4ae6
    3394:	6a 01                	push   $0x1
    3396:	e8 df 04 00 00       	call   387a <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    33b3:	68 f0 4a 00 00       	push   $0x4af0
    33b8:	6a 01                	push   $0x1
    33ba:	e8 bb 04 00 00       	call   387a <printf>
}
    ...
    33d8:	68 7c 52 00 00       	push   $0x527c
    33dd:	6a 01                	push   $0x1
    33df:	e8 96 04 00 00       	call   387a <printf>
    exit();
    33e4:	e8 37 03 00 00       	call   3720 <exit>
    printf (1, "fork failed\n");
    33e9:	83 ec 08             	sub    $0x8,%esp
    33ec:	68 75 4a 00 00       	push   $0x4a75
    33f1:	6a 01                	push   $0x1
    33f3:	e8 82 04 00 00       	call   387a <printf>
    exit();
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    3404:	6a 00                	push   $0x0
    3406:	68 ff 4a 00 00       	push   $0x4aff
  ...
  printf(1, "arg test passed\n");
    ...
    343d:	68 11 4b 00 00       	push   $0x4b11
    3442:	6a 01                	push   $0x1
    3444:	e8 31 04 00 00       	call   387a <printf>
}
    ...
    3454:	68 04 4b 00 00       	push   $0x4b04
    3459:	6a 02                	push   $0x2
    345b:	e8 1a 04 00 00       	call   387a <printf>
    exit();
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3468:	69 05 70 5b 00 00 0d 	imul   $0x19660d,0x5b70,%eax
    346f:	66 19 00 
    3472:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3477:	a3 70 5b 00 00       	mov    %eax,0x5b70
  return randstate;
}
    347c:	5d                   	pop    %ebp
    347d:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    348f:	68 22 4b 00 00       	push   $0x4b22
    3494:	6a 01                	push   $0x1
    3496:	e8 df 03 00 00       	call   387a <printf>

  if(open("usertests.ran", 0) >= 0){
    349b:	83 c4 08             	add    $0x8,%esp
    349e:	6a 00                	push   $0x0
    34a0:	68 36 4b 00 00       	push   $0x4b36
    ...
    34b4:	68 a0 52 00 00       	push   $0x52a0
    34b9:	6a 01                	push   $0x1
    34bb:	e8 ba 03 00 00       	call   387a <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    34cd:	68 36 4b 00 00       	push   $0x4b36
...
putc(int fd, char c)
{
    ...
    37e3:	83 ec 1c             	sub    $0x1c,%esp
    37e6:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    37e9:	6a 01                	push   $0x1
    37eb:	8d 55 f4             	lea    -0xc(%ebp),%edx
    37ee:	52                   	push   %edx
    37ef:	50                   	push   %eax
    37f0:	e8 4b ff ff ff       	call   3740 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    37fe:	56                   	push   %esi
    37ff:	53                   	push   %ebx
    3800:	83 ec 2c             	sub    $0x2c,%esp
    3803:	89 c7                	mov    %eax,%edi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3805:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    3809:	0f 95 c3             	setne  %bl
    380c:	89 d0                	mov    %edx,%eax
    380e:	c1 e8 1f             	shr    $0x1f,%eax
    3811:	84 c3                	test   %al,%bl
    3813:	74 10                	je     3825 <printint+0x2b>
    neg = 1;
    x = -xx;
    3815:	f7 da                	neg    %edx
    neg = 1;
    3817:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    381e:	be 00 00 00 00       	mov    $0x0,%esi
    3823:	eb 0b                	jmp    3830 <printint+0x36>
  neg = 0;
    3825:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    382c:	eb f0                	jmp    381e <printint+0x24>
  do{
    buf[i++] = digits[x % base];
    382e:	89 c6                	mov    %eax,%esi
    3830:	89 d0                	mov    %edx,%eax
    3832:	ba 00 00 00 00       	mov    $0x0,%edx
    3837:	f7 f1                	div    %ecx
    3839:	89 c3                	mov    %eax,%ebx
    383b:	8d 46 01             	lea    0x1(%esi),%eax
    383e:	0f b6 92 d4 52 00 00 	movzbl 0x52d4(%edx),%edx
    3845:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
    3849:	89 da                	mov    %ebx,%edx
    384b:	85 db                	test   %ebx,%ebx
    384d:	75 df                	jne    382e <printint+0x34>
    384f:	89 c3                	mov    %eax,%ebx
  if(neg)
    3851:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    3855:	74 16                	je     386d <printint+0x73>
    buf[i++] = '-';
    3857:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
    385c:	8d 5e 02             	lea    0x2(%esi),%ebx
    385f:	eb 0c                	jmp    386d <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
    3861:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3866:	89 f8                	mov    %edi,%eax
    3868:	e8 73 ff ff ff       	call   37e0 <putc>
  while(--i >= 0)
    386d:	83 eb 01             	sub    $0x1,%ebx
    3870:	79 ef                	jns    3861 <printint+0x67>
}
    3872:	83 c4 2c             	add    $0x2c,%esp
    3875:	5b                   	pop    %ebx
    3876:	5e                   	pop    %esi
    3877:	5f                   	pop    %edi
    3878:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3883:	8d 45 10             	lea    0x10(%ebp),%eax
    3886:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    3889:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    388e:	bb 00 00 00 00       	mov    $0x0,%ebx
    3893:	eb 14                	jmp    38a9 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3895:	89 fa                	mov    %edi,%edx
    3897:	8b 45 08             	mov    0x8(%ebp),%eax
    389a:	e8 41 ff ff ff       	call   37e0 <putc>
    389f:	eb 05                	jmp    38a6 <printf+0x2c>
      }
    } else if(state == '%'){
    38a1:	83 fe 25             	cmp    $0x25,%esi
    38a4:	74 25                	je     38cb <printf+0x51>
  for(i = 0; fmt[i]; i++){
    38a6:	83 c3 01             	add    $0x1,%ebx
    38a9:	8b 45 0c             	mov    0xc(%ebp),%eax
    38ac:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    38b0:	84 c0                	test   %al,%al
    38b2:	0f 84 23 01 00 00    	je     39db <printf+0x161>
    c = fmt[i] & 0xff;
    38b8:	0f be f8             	movsbl %al,%edi
    38bb:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    38be:	85 f6                	test   %esi,%esi
    38c0:	75 df                	jne    38a1 <printf+0x27>
      if(c == '%'){
    38c2:	83 f8 25             	cmp    $0x25,%eax
    38c5:	75 ce                	jne    3895 <printf+0x1b>
        state = '%';
    38c7:	89 c6                	mov    %eax,%esi
    38c9:	eb db                	jmp    38a6 <printf+0x2c>
      if(c == 'd'){
    38cb:	83 f8 64             	cmp    $0x64,%eax
    38ce:	74 49                	je     3919 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    38d0:	83 f8 78             	cmp    $0x78,%eax
    38d3:	0f 94 c1             	sete   %cl
    38d6:	83 f8 70             	cmp    $0x70,%eax
    38d9:	0f 94 c2             	sete   %dl
    38dc:	08 d1                	or     %dl,%cl
    38de:	75 63                	jne    3943 <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    38e0:	83 f8 73             	cmp    $0x73,%eax
    38e3:	0f 84 84 00 00 00    	je     396d <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    38e9:	83 f8 63             	cmp    $0x63,%eax
    38ec:	0f 84 b7 00 00 00    	je     39a9 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    38f2:	83 f8 25             	cmp    $0x25,%eax
    38f5:	0f 84 cc 00 00 00    	je     39c7 <printf+0x14d>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    38fb:	ba 25 00 00 00       	mov    $0x25,%edx
    3900:	8b 45 08             	mov    0x8(%ebp),%eax
    3903:	e8 d8 fe ff ff       	call   37e0 <putc>
        putc(fd, c);
    3908:	89 fa                	mov    %edi,%edx
    390a:	8b 45 08             	mov    0x8(%ebp),%eax
    390d:	e8 ce fe ff ff       	call   37e0 <putc>
      }
      state = 0;
    3912:	be 00 00 00 00       	mov    $0x0,%esi
    3917:	eb 8d                	jmp    38a6 <printf+0x2c>
        printint(fd, *ap, 10, 1);
    3919:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    391c:	8b 17                	mov    (%edi),%edx
    391e:	83 ec 0c             	sub    $0xc,%esp
    3921:	6a 01                	push   $0x1
    3923:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3928:	8b 45 08             	mov    0x8(%ebp),%eax
    392b:	e8 ca fe ff ff       	call   37fa <printint>
        ap++;
    3930:	83 c7 04             	add    $0x4,%edi
    3933:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3936:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3939:	be 00 00 00 00       	mov    $0x0,%esi
    393e:	e9 63 ff ff ff       	jmp    38a6 <printf+0x2c>
        printint(fd, *ap, 16, 0);
    3943:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3946:	8b 17                	mov    (%edi),%edx
    3948:	83 ec 0c             	sub    $0xc,%esp
    394b:	6a 00                	push   $0x0
    394d:	b9 10 00 00 00       	mov    $0x10,%ecx
    3952:	8b 45 08             	mov    0x8(%ebp),%eax
    3955:	e8 a0 fe ff ff       	call   37fa <printint>
        ap++;
    395a:	83 c7 04             	add    $0x4,%edi
    395d:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3960:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3963:	be 00 00 00 00       	mov    $0x0,%esi
    3968:	e9 39 ff ff ff       	jmp    38a6 <printf+0x2c>
        s = (char*)*ap;
    396d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3970:	8b 30                	mov    (%eax),%esi
        ap++;
    3972:	83 c0 04             	add    $0x4,%eax
    3975:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    3978:	85 f6                	test   %esi,%esi
    397a:	75 28                	jne    39a4 <printf+0x12a>
          s = "(null)";
    397c:	be cc 52 00 00       	mov    $0x52cc,%esi
    3981:	8b 7d 08             	mov    0x8(%ebp),%edi
    3984:	eb 0d                	jmp    3993 <printf+0x119>
          putc(fd, *s);
    3986:	0f be d2             	movsbl %dl,%edx
    3989:	89 f8                	mov    %edi,%eax
    398b:	e8 50 fe ff ff       	call   37e0 <putc>
          s++;
    3990:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    3993:	0f b6 16             	movzbl (%esi),%edx
    3996:	84 d2                	test   %dl,%dl
    3998:	75 ec                	jne    3986 <printf+0x10c>
      state = 0;
    399a:	be 00 00 00 00       	mov    $0x0,%esi
    399f:	e9 02 ff ff ff       	jmp    38a6 <printf+0x2c>
    39a4:	8b 7d 08             	mov    0x8(%ebp),%edi
    39a7:	eb ea                	jmp    3993 <printf+0x119>
        putc(fd, *ap);
    39a9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    39ac:	0f be 17             	movsbl (%edi),%edx
    39af:	8b 45 08             	mov    0x8(%ebp),%eax
    39b2:	e8 29 fe ff ff       	call   37e0 <putc>
        ap++;
    39b7:	83 c7 04             	add    $0x4,%edi
    39ba:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    39bd:	be 00 00 00 00       	mov    $0x0,%esi
    39c2:	e9 df fe ff ff       	jmp    38a6 <printf+0x2c>
        putc(fd, c);
    39c7:	89 fa                	mov    %edi,%edx
    39c9:	8b 45 08             	mov    0x8(%ebp),%eax
    39cc:	e8 0f fe ff ff       	call   37e0 <putc>
      state = 0;
    39d1:	be 00 00 00 00       	mov    $0x0,%esi
    39d6:	e9 cb fe ff ff       	jmp    38a6 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    39ef:	a1 20 5c 00 00       	mov    0x5c20,%eax
  ...
  freep = p;
    3a2d:	a3 20 5c 00 00       	mov    %eax,0x5c20
}
    3a32:	5b                   	pop    %ebx
    3a33:	5e                   	pop    %esi
    3a34:	5f                   	pop    %edi
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3a72:	50                   	push   %eax
    3a73:	e8 30 fd ff ff       	call   37a8 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3a8f:	a1 20 5c 00 00       	mov    0x5c20,%eax
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3ab6:	8b 0d 20 5c 00 00    	mov    0x5c20,%ecx
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3ac2:	eb 4d                	jmp    3b11 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
    3ac4:	c7 05 20 5c 00 00 24 	movl   $0x5c24,0x5c20
    3acb:	5c 00 00 
    3ace:	c7 05 24 5c 00 00 24 	movl   $0x5c24,0x5c24
    3ad5:	5c 00 00 
    base.s.size = 0;
    3ad8:	c7 05 28 5c 00 00 00 	movl   $0x0,0x5c28
    3adf:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3ae2:	b9 24 5c 00 00       	mov    $0x5c24,%ecx
    3ae7:	eb d7                	jmp    3ac0 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3ae9:	39 da                	cmp    %ebx,%edx
    3aeb:	74 1a                	je     3b07 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3aed:	29 da                	sub    %ebx,%edx
    3aef:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3af2:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3af5:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3af8:	89 0d 20 5c 00 00    	mov    %ecx,0x5c20
      return (void*)(p + 1);
    ...
    3b01:	83 c4 04             	add    $0x4,%esp
    3b04:	5b                   	pop    %ebx
    3b05:	5d                   	pop    %ebp
    3b06:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3b07:	8b 10                	mov    (%eax),%edx
    3b09:	89 11                	mov    %edx,(%ecx)
    3b0b:	eb eb                	jmp    3af8 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b0d:	89 c1                	mov    %eax,%ecx
    3b0f:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3b11:	8b 50 04             	mov    0x4(%eax),%edx
    3b14:	39 da                	cmp    %ebx,%edx
    3b16:	73 d1                	jae    3ae9 <malloc+0x46>
    if(p == freep)
    3b18:	39 05 20 5c 00 00    	cmp    %eax,0x5c20
    3b1e:	75 ed                	jne    3b0d <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
    3b20:	89 d8                	mov    %ebx,%eax
    3b22:	e8 2c ff ff ff       	call   3a53 <morecore>
    3b27:	85 c0                	test   %eax,%eax
    3b29:	75 e2                	jne    3b0d <malloc+0x6a>
        return 0;
    3b2b:	b8 00 00 00 00       	mov    $0x0,%eax
    3b30:	eb cf                	jmp    3b01 <malloc+0x5e>
