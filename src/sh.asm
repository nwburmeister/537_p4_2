...
getcmd(char *buf, int nbuf)
{
  ...
  13:	6a 02                	push   $0x2
  15:	e8 8e 0c 00 00       	call   ca8 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  59:	6a 02                	push   $0x2
  5b:	e8 48 0c 00 00       	call   ca8 <printf>
  exit();
...
00000084 <runcmd>:
{
  ...
  d1:	6a 02                	push   $0x2
  d3:	e8 d0 0b 00 00       	call   ca8 <printf>
    break;
 ...
 10b:	68 7f 0f 00 00       	push   $0xf7f
 110:	6a 02                	push   $0x2
 112:	e8 91 0b 00 00       	call   ca8 <printf>
      exit();
...
execcmd(void)
{
 ...
 231:	6a 54                	push   $0x54
 233:	e8 99 0c 00 00       	call   ed1 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 258:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 25b:	6a 18                	push   $0x18
 25d:	e8 6f 0c 00 00       	call   ed1 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 2a0:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a3:	6a 0c                	push   $0xc
 2a5:	e8 27 0c 00 00       	call   ed1 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2d6:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2d9:	6a 0c                	push   $0xc
 2db:	e8 f1 0b 00 00       	call   ed1 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 30c:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 30f:	6a 08                	push   $0x8
 311:	e8 bb 0b 00 00       	call   ed1 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 35b:	50                   	push   %eax
 35c:	68 cc 15 00 00       	push   $0x15cc
 ...
 3dd:	50                   	push   %eax
 3de:	68 cc 15 00 00       	push   $0x15cc
 ...
 3f5:	50                   	push   %eax
 3f6:	68 c4 15 00 00       	push   $0x15c4
 ...
 432:	50                   	push   %eax
 433:	68 cc 15 00 00       	push   $0x15cc
...
peek(char **ps, char *es, char *toks)
{
 ...
 473:	50                   	push   %eax
 474:	68 cc 15 00 00       	push   $0x15cc
...
parseexec(char **ps, char *es)
{
 ...
 649:	68 b6 0f 00 00       	push   $0xfb6
 64e:	e8 f8 f9 ff ff       	call   4b <panic>
      panic("too many args");
 653:	83 ec 0c             	sub    $0xc,%esp
 656:	68 bd 0f 00 00       	push   $0xfbd
...
nulterminate(struct cmd *cmd)
{
 ...
 800:	ff 24 85 30 10 00 00 	jmp    *0x1030(,%eax,4)
  case EXEC:
...
00000882 <parsecmd>:
{
 ...
 8d5:	50                   	push   %eax
 8d6:	68 f2 0f 00 00       	push   $0xff2
 8db:	6a 02                	push   $0x2
 8dd:	e8 c6 03 00 00       	call   ca8 <printf>
    panic("syntax");
 8e2:	c7 04 24 b6 0f 00 00 	movl   $0xfb6,(%esp)
...
000008ee <main>:
{
 ...
 902:	6a 02                	push   $0x2
 904:	68 01 10 00 00       	push   $0x1001
 ...
 996:	68 09 10 00 00       	push   $0x1009
 99b:	6a 02                	push   $0x2
 99d:	e8 06 03 00 00       	call   ca8 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c31:	89 c7                	mov    %eax,%edi
  ...
  neg = 0;
  if(sgn && xx < 0){
 c33:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 c37:	0f 95 c3             	setne  %bl
 c3a:	89 d0                	mov    %edx,%eax
 c3c:	c1 e8 1f             	shr    $0x1f,%eax
 c3f:	84 c3                	test   %al,%bl
 c41:	74 10                	je     c53 <printint+0x2b>
    neg = 1;
    x = -xx;
 c43:	f7 da                	neg    %edx
    neg = 1;
 c45:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }
 ...
 c51:	eb 0b                	jmp    c5e <printint+0x36>
  neg = 0;
 c53:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 c5a:	eb f0                	jmp    c4c <printint+0x24>
  do{
    buf[i++] = digits[x % base];
 c5c:	89 c6                	mov    %eax,%esi
 c5e:	89 d0                	mov    %edx,%eax
 c60:	ba 00 00 00 00       	mov    $0x0,%edx
 c65:	f7 f1                	div    %ecx
 c67:	89 c3                	mov    %eax,%ebx
 c69:	8d 46 01             	lea    0x1(%esi),%eax
 c6c:	0f b6 92 50 10 00 00 	movzbl 0x1050(%edx),%edx
 c73:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
 c77:	89 da                	mov    %ebx,%edx
 c79:	85 db                	test   %ebx,%ebx
 c7b:	75 df                	jne    c5c <printint+0x34>
 c7d:	89 c3                	mov    %eax,%ebx
  if(neg)
 c7f:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 c83:	74 16                	je     c9b <printint+0x73>
    buf[i++] = '-';
 c85:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
 c8a:	8d 5e 02             	lea    0x2(%esi),%ebx
 c8d:	eb 0c                	jmp    c9b <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
 c8f:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 c94:	89 f8                	mov    %edi,%eax
 c96:	e8 73 ff ff ff       	call   c0e <putc>
  while(--i >= 0)
 c9b:	83 eb 01             	sub    $0x1,%ebx
 c9e:	79 ef                	jns    c8f <printint+0x67>
}
 ca0:	83 c4 2c             	add    $0x2c,%esp
 ca3:	5b                   	pop    %ebx
 ca4:	5e                   	pop    %esi
 ca5:	5f                   	pop    %edi
 ca6:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
 ...
 cae:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 cb1:	8d 45 10             	lea    0x10(%ebp),%eax
 cb4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 cb7:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 cbc:	bb 00 00 00 00       	mov    $0x0,%ebx
 cc1:	eb 14                	jmp    cd7 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
 cc3:	89 fa                	mov    %edi,%edx
 cc5:	8b 45 08             	mov    0x8(%ebp),%eax
 cc8:	e8 41 ff ff ff       	call   c0e <putc>
 ccd:	eb 05                	jmp    cd4 <printf+0x2c>
      }
    } else if(state == '%'){
 ccf:	83 fe 25             	cmp    $0x25,%esi
 cd2:	74 25                	je     cf9 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 cd4:	83 c3 01             	add    $0x1,%ebx
 cd7:	8b 45 0c             	mov    0xc(%ebp),%eax
 cda:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 cde:	84 c0                	test   %al,%al
 ce0:	0f 84 23 01 00 00    	je     e09 <printf+0x161>
    c = fmt[i] & 0xff;
 ce6:	0f be f8             	movsbl %al,%edi
 ce9:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 cec:	85 f6                	test   %esi,%esi
 cee:	75 df                	jne    ccf <printf+0x27>
      if(c == '%'){
 cf0:	83 f8 25             	cmp    $0x25,%eax
 cf3:	75 ce                	jne    cc3 <printf+0x1b>
        state = '%';
 cf5:	89 c6                	mov    %eax,%esi
 cf7:	eb db                	jmp    cd4 <printf+0x2c>
      if(c == 'd'){
 cf9:	83 f8 64             	cmp    $0x64,%eax
 cfc:	74 49                	je     d47 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 cfe:	83 f8 78             	cmp    $0x78,%eax
 d01:	0f 94 c1             	sete   %cl
 d04:	83 f8 70             	cmp    $0x70,%eax
 d07:	0f 94 c2             	sete   %dl
 d0a:	08 d1                	or     %dl,%cl
 d0c:	75 63                	jne    d71 <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 d0e:	83 f8 73             	cmp    $0x73,%eax
 d11:	0f 84 84 00 00 00    	je     d9b <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 d17:	83 f8 63             	cmp    $0x63,%eax
 d1a:	0f 84 b7 00 00 00    	je     dd7 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 d20:	83 f8 25             	cmp    $0x25,%eax
 d23:	0f 84 cc 00 00 00    	je     df5 <printf+0x14d>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 d29:	ba 25 00 00 00       	mov    $0x25,%edx
 d2e:	8b 45 08             	mov    0x8(%ebp),%eax
 d31:	e8 d8 fe ff ff       	call   c0e <putc>
        putc(fd, c);
 d36:	89 fa                	mov    %edi,%edx
 d38:	8b 45 08             	mov    0x8(%ebp),%eax
 d3b:	e8 ce fe ff ff       	call   c0e <putc>
      }
      state = 0;
 d40:	be 00 00 00 00       	mov    $0x0,%esi
 d45:	eb 8d                	jmp    cd4 <printf+0x2c>
        printint(fd, *ap, 10, 1);
 d47:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d4a:	8b 17                	mov    (%edi),%edx
 d4c:	83 ec 0c             	sub    $0xc,%esp
 d4f:	6a 01                	push   $0x1
 d51:	b9 0a 00 00 00       	mov    $0xa,%ecx
 d56:	8b 45 08             	mov    0x8(%ebp),%eax
 d59:	e8 ca fe ff ff       	call   c28 <printint>
        ap++;
 ...
 d6c:	e9 63 ff ff ff       	jmp    cd4 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 d71:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d74:	8b 17                	mov    (%edi),%edx
 d76:	83 ec 0c             	sub    $0xc,%esp
 d79:	6a 00                	push   $0x0
 d7b:	b9 10 00 00 00       	mov    $0x10,%ecx
 d80:	8b 45 08             	mov    0x8(%ebp),%eax
 d83:	e8 a0 fe ff ff       	call   c28 <printint>
        ap++;
 d88:	83 c7 04             	add    $0x4,%edi
 d8b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 d8e:	83 c4 10             	add    $0x10,%esp
      state = 0;
 d91:	be 00 00 00 00       	mov    $0x0,%esi
 d96:	e9 39 ff ff ff       	jmp    cd4 <printf+0x2c>
        s = (char*)*ap;
 d9b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 d9e:	8b 30                	mov    (%eax),%esi
        ap++;
 da0:	83 c0 04             	add    $0x4,%eax
 da3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 da6:	85 f6                	test   %esi,%esi
 da8:	75 28                	jne    dd2 <printf+0x12a>
          s = "(null)";
 daa:	be 48 10 00 00       	mov    $0x1048,%esi
 daf:	8b 7d 08             	mov    0x8(%ebp),%edi
 db2:	eb 0d                	jmp    dc1 <printf+0x119>
          putc(fd, *s);
 db4:	0f be d2             	movsbl %dl,%edx
 db7:	89 f8                	mov    %edi,%eax
 db9:	e8 50 fe ff ff       	call   c0e <putc>
          s++;
 dbe:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 dc1:	0f b6 16             	movzbl (%esi),%edx
 dc4:	84 d2                	test   %dl,%dl
 dc6:	75 ec                	jne    db4 <printf+0x10c>
      state = 0;
 dc8:	be 00 00 00 00       	mov    $0x0,%esi
 dcd:	e9 02 ff ff ff       	jmp    cd4 <printf+0x2c>
 dd2:	8b 7d 08             	mov    0x8(%ebp),%edi
 dd5:	eb ea                	jmp    dc1 <printf+0x119>
        putc(fd, *ap);
 dd7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 dda:	0f be 17             	movsbl (%edi),%edx
 ...
 de8:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 deb:	be 00 00 00 00       	mov    $0x0,%esi
 df0:	e9 df fe ff ff       	jmp    cd4 <printf+0x2c>
        putc(fd, c);
 df5:	89 fa                	mov    %edi,%edx
 df7:	8b 45 08             	mov    0x8(%ebp),%eax
 dfa:	e8 0f fe ff ff       	call   c0e <putc>
      state = 0;
 dff:	be 00 00 00 00       	mov    $0x0,%esi
 e04:	e9 cb fe ff ff       	jmp    cd4 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 e1d:	a1 44 16 00 00       	mov    0x1644,%eax
 ...
 e59:	89 08                	mov    %ecx,(%eax)
  freep = p;
 e5b:	a3 44 16 00 00       	mov    %eax,0x1644
}
 e60:	5b                   	pop    %ebx
 e61:	5e                   	pop    %esi
 e62:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 eb8:	e8 54 ff ff ff       	call   e11 <free>
  return freep;
 ebd:	a1 44 16 00 00       	mov    0x1644,%eax
...
malloc(uint nbytes)
{
 ...
 ee1:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 ee4:	8b 0d 44 16 00 00    	mov    0x1644,%ecx
 ...
 ef0:	eb 4d                	jmp    f3f <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 ef2:	c7 05 44 16 00 00 48 	movl   $0x1648,0x1644
 ef9:	16 00 00 
 efc:	c7 05 48 16 00 00 48 	movl   $0x1648,0x1648
 f03:	16 00 00 
    base.s.size = 0;
 f06:	c7 05 4c 16 00 00 00 	movl   $0x0,0x164c
 f0d:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f10:	b9 48 16 00 00       	mov    $0x1648,%ecx
 f15:	eb d7                	jmp    eee <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f17:	39 da                	cmp    %ebx,%edx
 f19:	74 1a                	je     f35 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 f1b:	29 da                	sub    %ebx,%edx
 f1d:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 f20:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 f23:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 f26:	89 0d 44 16 00 00    	mov    %ecx,0x1644
      return (void*)(p + 1);
 f2c:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
 ...
 f34:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 f35:	8b 10                	mov    (%eax),%edx
 f37:	89 11                	mov    %edx,(%ecx)
 f39:	eb eb                	jmp    f26 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f3b:	89 c1                	mov    %eax,%ecx
 f3d:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 f3f:	8b 50 04             	mov    0x4(%eax),%edx
 f42:	39 da                	cmp    %ebx,%edx
 f44:	73 d1                	jae    f17 <malloc+0x46>
    if(p == freep)
 f46:	39 05 44 16 00 00    	cmp    %eax,0x1644
 f4c:	75 ed                	jne    f3b <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
 f4e:	89 d8                	mov    %ebx,%eax
 f50:	e8 2c ff ff ff       	call   e81 <morecore>
 f55:	85 c0                	test   %eax,%eax
 f57:	75 e2                	jne    f3b <malloc+0x6a>
        return 0;
 f59:	b8 00 00 00 00       	mov    $0x0,%eax
 f5e:	eb cf                	jmp    f2f <malloc+0x5e>
